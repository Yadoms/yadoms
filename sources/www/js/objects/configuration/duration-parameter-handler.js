...
function DurationParameterHandler(i18nContext, i18nKey, paramName, content, currentValue, autocomplete) {
    ...
    //regex for hour
    this.regex = "([0-1][0-9]|2[0-3]):([0-5][0-9]):([0-5][0-9])";
    
    //we cannot read the read directly from the sub item set-value-keyword-keyword-configuration, because this element is a numeric, but the display is different
