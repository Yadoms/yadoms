...
(function () {
   ...
   var getIsoLanguageArray = function() {
      var result = {};
      $.each(isoLangs, function(index, value) {
         result[index] = value["nativeName"] + " (" + value["name"] + ")";
      });
      return result;
   }
   ...
   window.getIsoLanguageArray = getIsoLanguageArray;
})();
