...
{   
   ...
   public:
      ...
      //-----------------------------------------------------
      explicit CWeatherCondition(const std::string& keywordName, const EKeywordAccessMode& accessMode = EKeywordAccessMode::kGet, const EMeasureType& measureType = EMeasureType::kAbsolute);
