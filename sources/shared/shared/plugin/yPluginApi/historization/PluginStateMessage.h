...
namespace shared { namespace plugin { namespace yPluginApi { namespace historization
{
   ...
   //-----------------------------------------------------
   class YADOMS_SHARED_EXPORT CPluginStateMessage : public CSingleHistorizableData< shared::CDataContainer >
   {
   public:
      //-----------------------------------------------------
      ///\brief                     Constructor
      ...
      //-----------------------------------------------------
      CPluginStateMessage(const std::string& keywordName, const EKeywordAccessMode& accessMode = EKeywordAccessMode::kGet);
      ...
      //-----------------------------------------------------
      void setMessage(const std::string & messageId, const std::string & messageData);
      ...
      //-----------------------------------------------------
      void setMessage(const std::string & messageId, const std::string & messageDataParam, const std::string & messageDataValue);
      ...
      //-----------------------------------------------------
      void setMessage(const std::string & messageId, const std::map<std::string, std::string> & messageDataParameters);
