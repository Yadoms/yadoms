...
namespace shared
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      static CDataContainerSharedPtr sendGetRequest(const std::string& url,
      ...
      /// \return     the answer of the request
      //--------------------------------------------------------------
      static CDataContainerSharedPtr sendPostRequest(const std::string& url,
   ...
   protected:
      ...
      static CDataContainerSharedPtr processJsonResponse(const Poco::Net::HTTPResponse& response,
