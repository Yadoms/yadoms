...
if __name__ == '__main__':
   ...
   yApi = yScriptApiWrapper27.createScriptApiInstance(contextAccessorId)
   ...
   yScriptApiWrapper27.deleteScriptApiInstance(yApi)
