...
boost::posix_time::ptime CDayLightProvider::hoursToLocalTime(const boost::gregorian::date& date, double hours)
{
   // Use the Os settings to adjust to local time
   typedef boost::date_time::c_local_adjustor<boost::posix_time::ptime> local_adj;
   return local_adj::utc_to_local(boost::posix_time::ptime(date,
      boost::posix_time::hours(floor(hours)) + boost::posix_time::minutes(lround(hours * 60) % 60)));
}
