...
namespace automation { namespace script
{
   ...
   public:
      ...
      virtual shared::script::yScriptApi::CWaitForEventResult waitForEvent(const std::vector<int> & keywordIdList, const std::vector<std::string> & capacities, bool receiveDateTimeEvent, const std::string& timeout) const;
