...
namespace automation
{
   CRuleManager::CRuleManager(const IPathProvider& pathProvider,
      ...
      : m_ruleRequester(dbRequester),
        ...
        m_scriptManager(boost::make_shared<script::CManager>(pathProvider, pluginGateway, configurationManager, dbAcquisitionRequester, dbDeviceRequester, dbKeywordRequester, dbRecipientRequester)),
