...
namespace automation
{
   ...
   protected:
      ...
      boost::shared_ptr<interpreter::IInstance> getInterpreterInstance(const std::string& interpreterType) override;
      void unloadInterpreter(const std::string& interpreterName) override;
      boost::shared_ptr<script::IProperties> createScriptProperties(boost::shared_ptr<const database::entities::CRule> ruleData) override;
   ...
   private:
      ...
      //-----------------------------------------------------
      std::map<std::string, boost::shared_ptr<interpreter::IInstance>> m_loadedInterpreters;
