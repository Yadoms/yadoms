...
CJson CConfigurationRestService::getSectionConfigurations(const std::vector<std::string> & parameters, const CJson & requestContent)
{
   ...
   return CJsonResult::GenerateSuccess(CJsonCollectionSerializer<database::entities::CConfiguration>::SerializeCollection(hwList, hes, getRestKeyword()));
}
...
CJson CConfigurationRestService::updateAllConfigurations(const std::vector<std::string> & parameters, const CJson & requestContent)
{
   ...
   {
      CConfigurationEntitySerializer hes;
      std::vector<boost::shared_ptr<database::entities::CConfiguration> > listToUpdate = CJsonCollectionSerializer<database::entities::CConfiguration>::DeserializeCollection(requestContent, hes, getRestKeyword());
