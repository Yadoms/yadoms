...
boost::shared_ptr<web::rest::IAnswer> CPlugin::getAvailablePluginsV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // Filter by type
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::getPluginsInstancesV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::createPluginsInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::updatePluginsInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::deletePluginsInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      return CHelpers::transactionalMethodV2(
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::getPluginsInstancesLogV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::getPluginsInstancesBindingV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::startPluginsInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::sendExtraQueryToPluginInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CPlugin::stopPluginsInstanceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
