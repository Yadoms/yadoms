...
boost::shared_ptr<web::rest::IAnswer> CKeyword::getKeywordsV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CKeyword::getKeywordsAcquisitionsV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CKeyword::updateKeywordV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CKeyword::sendCommandV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
