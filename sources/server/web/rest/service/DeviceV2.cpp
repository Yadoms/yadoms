...
boost::shared_ptr<web::rest::IAnswer> CDevice::getDevicesV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
   ...
   const std::vector<std::string>& locales) const
{
   try
   {
      if (auto schema = getDeviceStaticConfigurationSchema(device, locales); !schema->empty())
         return schema;

      if (auto schema = getDeviceDynamicConfigurationSchema(device, locales); !schema->empty())
         return schema;
   ...
   {
      YADOMS_LOG(error) << "Fail to get device configuration schema : " << exception.what();
...
boost::shared_ptr<web::rest::IAnswer> CDevice::sendExtraQueryToDeviceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CDevice::createDeviceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      return CHelpers::transactionalMethodV2(
...
boost::shared_ptr<web::rest::IAnswer> CDevice::updateDeviceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      // ID
...
boost::shared_ptr<web::rest::IAnswer> CDevice::deleteDeviceV2(const boost::shared_ptr<IRequest>& request) const
{
   try
   {
      return CHelpers::transactionalMethodV2(
