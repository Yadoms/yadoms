...
namespace web { namespace rest {
   ...
   shared::CDataContainer CRestDispatcher::callRealMethod(CRestMethodHandler realMethod, CRestMethodIndirector encapsulatedMethod, const std::vector<std::string> & url, const std::string & requestContent)
   {
