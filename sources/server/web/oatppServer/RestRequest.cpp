...
web::rest::EContentType CRestRequest::contentType() const
{
...
std::vector<std::string> CRestRequest::acceptLanguages() const
{
   ...
   std::sort(weightedLanguages.begin(),
             ...
             [](const LanguagePreference& a,
                const LanguagePreference& b)
             {
...
boost::shared_ptr<web::rest::IFormDataPartStringHandler> CRestRequest::createFormDataPartStringHandler()
{
   return boost::make_shared<CFormDataPartStringHandler>();
}

boost::shared_ptr<web::rest::IFormDataPartFileHandler> CRestRequest::createFormDataPartFileHandler(const boost::filesystem::path& path)
{
...
boost::shared_ptr<std::map<web::rest::EContentType, float>> CRestRequest::parseAcceptContentType() const
{
