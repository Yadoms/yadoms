...
namespace web
{
   namespace poco
   {
      ...
      public:
         ...
         //-----------------------------------------
         static boost::shared_ptr<shared::CDataContainer> GenerateError(const std::string& errorMessage = std::string(),
         ...
         ///\return  the message as shared::CDataContainer format
         //-----------------------------------------
         static boost::shared_ptr<shared::CDataContainer> GenerateError(const std::exception& error,
                                                                        const shared::CDataContainer& data = shared::CDataContainer::EmptyContainer);
         ...
         ///\return  the message as shared::CDataContainer format
         //-----------------------------------------
         static boost::shared_ptr<shared::CDataContainer>
         GenerateSuccess(const shared::CDataContainer& data = shared::CDataContainer::EmptyContainer);
      ...
      private:
         ...
         ///\return  the message as shared::CDataContainer format
         //-----------------------------------------
         static boost::shared_ptr<shared::CDataContainer> GenerateInternal(const bool result, const std::string& message,
