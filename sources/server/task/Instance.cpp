...
namespace task {
   ...
   void CInstance::OnTaskProgressUpdated(bool isRunning, boost::optional<float> progression, const std::string& message, const std::string& exception, boost::shared_ptr<shared::CDataContainer> taskData)
   {
      if (!isRunning)
