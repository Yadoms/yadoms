...
namespace database
{
   namespace common
   {
      namespace versioning
      {
         ...
         const shared::versioning::CSemVer CVersion_2_0_0::Version(2, 0, 0);

         // ISQLiteVersionUpgrade implementation
         void CVersion_2_0_0::checkForUpgrade(const boost::shared_ptr<IDatabaseRequester>& pRequester,
         ...
         void CVersion_2_0_0::UpdateFrom1_0_0(const boost::shared_ptr<IDatabaseRequester>& pRequester)
         {
            try
            {
