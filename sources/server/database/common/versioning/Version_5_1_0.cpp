...
namespace database
{
   namespace common
   {
      namespace versioning
      {
         ...
         const shared::versioning::CVersion CVersion_5_1_0::Version(5, 1, 0);
         ...
         void CVersion_5_1_0::updateFrom5_0_0(const boost::shared_ptr<IDatabaseRequester>& requester)
         {
            try
            {
               ...
               // Add column
               requester->addTableColumn(CKeywordTable::getTableName(), "historyDepth STRING NOT NULL default \"Default\"");
