...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::int8_t (or any int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::int8_t>
{
	static std::string format(CQuery* obj, const std::int8_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::uint8_t (or any unsigned int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::uint8_t>
{
	static std::string format(CQuery* obj, const std::uint8_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::int16_t (or any int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::int16_t>
{
	static std::string format(CQuery* obj, const std::int16_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::uint16_t (or any unsigned int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::uint16_t>
{
	static std::string format(CQuery* obj, const std::uint16_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::int32_t (or any int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::int32_t>
{
	static std::string format(CQuery* obj, const std::int32_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::uint32_t (or any unsigned int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::uint32_t>
{
	static std::string format(CQuery* obj, const std::uint32_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::int64_t (or any int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::int64_t>
{
	static std::string format(CQuery* obj, const std::int64_t& anyValue)
	{
...
//--------------------------------------------------------------
/// \brief	    Helper structure for converting std::uint64_t (or any unsigned int) to sql string
//--------------------------------------------------------------
template <>
struct queryhelper<std::uint64_t>
{
	static std::string format(CQuery* obj, const std::uint64_t& anyValue)
	{
