...
#define CQUERY_OP_MUL "*"
		...
		*/
		...
		public:
			...
			virtual std::string formatInt8ToSql(const std::int8_t& anyStringValue);
			virtual std::string formatUInt8ToSql(const std::uint8_t& anyStringValue);
			virtual std::string formatInt16ToSql(const std::int16_t& anyStringValue);
			virtual std::string formatUInt16ToSql(const std::uint16_t& anyStringValue);
			virtual std::string formatInt32ToSql(const std::int32_t& anyStringValue);
			virtual std::string formatUInt32ToSql(const std::uint32_t& anyStringValue);
			virtual std::string formatInt64ToSql(const std::int64_t& anyStringValue);
			virtual std::string formatUInt64ToSql(const std::uint64_t& anyStringValue);
