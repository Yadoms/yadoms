...
namespace database
{
   namespace common
   {
      namespace adapters
      {
         ...
         //--------------------------------------------------------------
         class CHugeDataVectorForKeywordSummaryDataAdapterV1 final : public IResultAdapterEx<std::string>
         {
         public:
            CHugeDataVectorForKeywordSummaryDataAdapterV1() = default;
            ~CHugeDataVectorForKeywordSummaryDataAdapterV1() override = default;
