...
namespace database
{
   namespace common
   {
      namespace adapters
      {
         ...
         //--------------------------------------------------------------
         class CSqlExtension final
         {
         public:
            CSqlExtension() = delete;
            ~CSqlExtension() = delete;
            ...
            ///\template      TValue         The type of the expected value
            ///\return The value from the column.
            //--------------------------------------------------------------
            template <class TValue>
            static TValue extractData(boost::shared_ptr<IResultHandler> resultHandler, int nCol);
         };
         ...
         //--------------------------------------------------------------
         template <class TValue>
         TValue CSqlExtension::extractData(boost::shared_ptr<IResultHandler> resultHandler, int nCol)
         {
         ...
         //--------------------------------------------------------------
         template <>
         inline const unsigned char* CSqlExtension::extractData(boost::shared_ptr<IResultHandler> resultHandler, int nCol)
         {
