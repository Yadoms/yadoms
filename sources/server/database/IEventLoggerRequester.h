...
namespace database { 
   ...
   public:
      ...
      /// \throw           shared::exception::CEmptyResult if fails
      //--------------------------------------------------------------
      virtual std::vector<const boost::shared_ptr<entities::CEventLogger> > getEvents() = 0;
      ...
      /// \throw           shared::exception::CEmptyResult if fails
      //--------------------------------------------------------------
      virtual std::vector<const boost::shared_ptr<entities::CEventLogger> > getEventsFrom(const int eventId) = 0;
      ...
      /// \return          list of events
      //--------------------------------------------------------------
      virtual std::vector<const boost::shared_ptr<entities::CEventLogger> > getEventsRange(const int offset, const int count) = 0;
