...
namespace database {  namespace sqlite { 
   ...
   namespace requesters { 
      ...
      public:
         ...
         virtual std::vector<boost::shared_ptr<entities::CDevice> > getDeviceWithCapacity(const std::string & capacityName, const database::entities::ECapacityAccessMode accessMode);
