...
namespace database {  namespace sqlite { 
   ...
   namespace requesters { 
      ...
      public:
         ...
         virtual std::vector<boost::shared_ptr<entities::CDevice> > getDeviceWithCapacity(const std::string & capacityName, const shared::plugin::yadomsApi::EKeywordAccessMode & accessMode) const;
         virtual std::vector<boost::shared_ptr<entities::CDevice> > getDeviceWithCapacityType(const shared::plugin::yadomsApi::EKeywordAccessMode & capacityAccessMode, const shared::plugin::yadomsApi::EKeywordDataType & capacityType) const;
