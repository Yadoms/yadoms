...
namespace database {  namespace sqlite { 
   ...
   namespace requesters { 
      ...
      public:
         ...
         virtual std::vector<boost::shared_ptr<entities::CDevice> > getDeviceWithCapacityType(const database::entities::EKeywordAccessMode & capacityAccessMode, const database::entities::EKeywordDataType & capacityType) const;
