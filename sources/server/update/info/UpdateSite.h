...
namespace update { namespace info {
   ...
   private:
      ...
      //---------------------------------------------
      static shared::CDataContainer callDistantScript(const std::string & script, bool includeOsAndArch, const std::string & displayLanguage, const std::string & resultFieldToReturn);
