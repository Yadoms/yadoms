...
namespace dataAccessLayer {
   ...
   public:
      ...
      //--------------------------------------------------------------
      virtual void saveData(int keywordId, const shared::plugin::yPluginApi::historization::IHistorizable & data) = 0;
      ...
      //--------------------------------------------------------------
      virtual void saveData(int keywordId, const shared::plugin::yPluginApi::historization::IHistorizable & data, boost::posix_time::ptime & dataTime) = 0;
   };
