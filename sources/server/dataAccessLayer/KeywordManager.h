...
namespace dataAccessLayer
{
   ...
   public:
      ...
      std::vector<boost::shared_ptr<database::entities::CKeyword>> getKeywordsMatchingCriteria(const std::vector<shared::plugin::yPluginApi::EKeywordDataType>& expectedKeywordTypes, const std::vector<std::string>& expectedCapacities, const std::vector<shared::plugin::yPluginApi::EKeywordAccessMode>& expectedKeywordAccesses, const std::vector<shared::plugin::yPluginApi::EHistoryDepth>& expectedKeywordHistoryDepth, bool blacklisted) const override;
      ...
      void addKeyword(int deviceId, const shared::plugin::yPluginApi::historization::IHistorizable& keyword, shared::CDataContainerSharedPtr details = new_CDataContainerSharedPtr()) override;
   ...
   private:
      ...
      static boost::shared_ptr<database::entities::CKeyword> makeKeywordEntity(int deviceId,
                                                                               ...
                                                                               keyword,
                                                                               shared::CDataContainerSharedPtr = new_CDataContainerSharedPtr());
