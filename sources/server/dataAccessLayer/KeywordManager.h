...
namespace dataAccessLayer
{
   ...
   public:
      ...
      boost::shared_ptr<database::entities::CKeyword> getKeyword(int deviceId,
      ...
      std::vector<boost::shared_ptr<database::entities::CKeyword>> getKeywordIdFromFriendlyName(int deviceId,
      ...
      std::vector<boost::shared_ptr<database::entities::CKeyword>> getDeviceKeywordsWithCapacity(
         int deviceId,
         const std::string& capacityName,
         const shared::plugin::yPluginApi::EKeywordAccessMode& capacityAccessMode) const override;
      std::vector<boost::shared_ptr<database::entities::CKeyword>> getKeywordsMatchingCriteria(
      ...
      void addKeyword(int deviceId, const shared::plugin::yPluginApi::historization::IHistorizable& keyword,
                      boost::shared_ptr<shared::CDataContainer> details = shared::CDataContainer::make()) override;
      void addKeywords(int deviceId, const std::vector<boost::shared_ptr<const shared::plugin::yPluginApi::historization::IHistorizable>>& keywords)
      override;
   ...
   private:
      ...
      static boost::shared_ptr<database::entities::CKeyword> makeKeywordEntity(
         int deviceId,
