...
using namespace startupOptions;
...
void CStartupOptions::defineOptions(Poco::Util::OptionSet& options) const
{
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlHostAddr", "pha",
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlPort", "pp",
                           "Specify PotgreSQL database port (only for postgresql database). Port number to connect to at the server host, or socket file name extension for Unix-domain connections.")
        .required(false)
        .repeatable(false)
        .argument("pgPort")
        .validator(new Poco::Util::IntValidator(1, 65535))
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbName", "pn",
                           "Specify PotgreSQL database name (only for postgresql database). The database name. Defaults to be the same as the user name. In certain contexts, the value is checked for extended formats; see https://www.postgresql.org/docs/9.3/static/libpq-connect.html#LIBPQ-CONNSTRING for more details on those.")
        .required(false)
        .repeatable(false)
        .argument("pgName")
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbLogin", "pl",
                           "Specify PotgreSQL database login (only for postgresql database). PostgreSQL user name to connect as. Defaults to be the same as the operating system name of the user running the application.")
        .required(false)
        .repeatable(false)
        .argument("pgLogin")
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbPassword", "pp",
                           "Specify PotgreSQL database password (only for postgresql database). Password to be used if the server demands password authentication.")
        .required(false)
        .repeatable(false)
        .argument("pgPassword")
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbConnectTimeout", "pt",
                           "Specify PotgreSQL database connection timeout (only for postgresql database). Maximum wait for connection, in seconds (write as a decimal integer string). Zero or not specified means wait indefinitely. It is not recommended to use a timeout of less than 2 seconds.")
        .required(false)
        .repeatable(false)
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbKeepAlives", "pk",
                           "Specify PotgreSQL database keep alives (only for postgresql database). Controls whether client-side TCP keepalives are used. The default value is 1, meaning on, but you can change this to 0, meaning off, if keepalives are not wanted. This parameter is ignored for connections made via a Unix-domain socket.")
        .required(false)
        .repeatable(false)
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbKeepAlivesInterval", "pkn",
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbKeepAlivesCount", "pkc",
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbSslcert", "psslcert",
                           "Specify PotgreSQL database ssl certificate name (only for postgresql database). This parameter specifies the file name of the client SSL certificate, replacing the default ~/.postgresql/postgresql.crt. This parameter is ignored if an SSL connection is not made.")
        .required(false)
        .repeatable(false)
        .argument("pgSslcert")
    ...
    options.addOption(
        Poco::Util::Option("databasePostgresqlDbGsslib", "pgss",
                           "Specify PotgreSQL database gss library (only for postgresql database). GSS library to use for GSSAPI authentication. Only used on Windows. Set to gssapi to force libpq to use the GSSAPI library for authentication instead of the default SSPI.")
        .required(false)
        .repeatable(false)
        .argument("pgGsslib")
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlHostAddr() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlConnectTimeout() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlClientEncoding() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlOptions() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlKeepAlives() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlKeepAlivesIdle() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlKeepAlivesInterval() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlKeepAlivesCount() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlSslMode() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlRequireSsl() const
{
...
std::optional<int> CStartupOptions::getDatabasePostgresqlSslCompression() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlSslCert() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlSslKey() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlSslRootCert() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlSslRevocationList() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlRequirePeer() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlKerberos() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlGssLib() const
{
...
std::optional<std::string> CStartupOptions::getDatabasePostgresqlService() const
{
...
std::optional<std::string> CStartupOptions::getProxyHost() const
{
...
std::optional<std::string> CStartupOptions::getProxyUsername() const
{
...
std::optional<std::string> CStartupOptions::getProxyPassword() const
{
...
std::optional<std::string> CStartupOptions::getProxyBypass() const
{
