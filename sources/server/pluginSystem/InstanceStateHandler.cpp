...
namespace pluginSystem
{
   ...
   int CInstanceStateHandler::pluginStateDeviceId() const
   {
      ...
      if (!m_deviceManager->deviceExists(m_instanceData->Id(), PluginStateDeviceName))
         m_deviceManager->createDevice(m_instanceData->Id(), PluginStateDeviceName, m_instanceData->DisplayName() + " plugin state", "pluginstate", "Plugin state", shared::CDataContainer::make());
