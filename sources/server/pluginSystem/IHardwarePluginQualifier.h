...
public:
   ...
   //--------------------------------------------------------------
   virtual void signalLoad(const boost::shared_ptr<const shared::plugin::IInformation> pluginInformation) = 0;

   //--------------------------------------------------------------
   /// \brief			         Signal that plugin was unloaded
   /// \param[in]  pluginInformation     Plugin information (name, version...)
   //--------------------------------------------------------------
   virtual void signalUnload(const boost::shared_ptr<const shared::plugin::IInformation> pluginInformation) = 0;
   ...
   //--------------------------------------------------------------
   virtual void signalCrash(const boost::shared_ptr<const shared::plugin::IInformation> pluginInformation, const std::string& reason) = 0;
   ...
   //--------------------------------------------------------------
   virtual bool isSafe(const boost::shared_ptr<const shared::plugin::IInformation> pluginInformation) = 0;
   ...
   virtual int getQualityLevel(const boost::shared_ptr<const shared::plugin::IInformation> pluginInformation) = 0;
};
