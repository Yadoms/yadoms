...
namespace xplrules
{
   namespace rfxLanXpl
   {
      namespace data
      {
         ...
         DECLARE_CAPACITY(DigimaxDemandCapacity, "digimax_demand", shared::plugin::yPluginApi::CStandardUnits::NoUnit(), shared::plugin::yPluginApi::EKeywordDataType::kNoData);
