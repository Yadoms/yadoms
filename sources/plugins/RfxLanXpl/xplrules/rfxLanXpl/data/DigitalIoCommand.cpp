...
namespace xplrules
{
   namespace rfxLanXpl
   {
      namespace data
      {
         ...
         DECLARE_CAPACITY(RfxLanDigitalIoCommandCapacity, "digitalio", shared::plugin::yPluginApi::CStandardUnits::NoUnit(), shared::plugin::yPluginApi::EKeywordDataType::kNoData);
