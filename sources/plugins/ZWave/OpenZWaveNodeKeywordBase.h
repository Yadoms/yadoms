...
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const bool& data)
{
	try
	{
		...
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::uint8_t>(data ? 1 : 0));
		}
		...
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::int32_t>(data ? 1 : 0));
		}
		case OpenZWave::ValueID::ValueType_Short:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::int16_t>(data ? 1 : 0));
		}
...
template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::uint8_t& data)
{
	try
	{
		switch (m_valueId.GetType())
		...
		case OpenZWave::ValueID::ValueType_Int:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::int32_t>(data));
		}
		case OpenZWave::ValueID::ValueType_Short:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::int16_t>(data));
		}
		case OpenZWave::ValueID::ValueType_String:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, (boost::format("%1%") % data).str());
...
template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::int8_t& data)
{
	return realSendCommand<std::uint8_t>(static_cast<std::uint8_t>(data));
}

template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::int16_t& data)
{
	try
	{
		switch (m_valueId.GetType())
		...
		case OpenZWave::ValueID::ValueType_Byte:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<std::uint8_t>(data));
		}
		case OpenZWave::ValueID::ValueType_Decimal:
		{
			return OpenZWave::Manager::Get()->SetValue(m_valueId, static_cast<float>(data));
...
template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::uint16_t& data)
{
	return realSendCommand<std::int16_t>(static_cast<std::int16_t>(data));
}

template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::int32_t& data)
{
	try
	{
		switch (m_valueId.GetType())
...
template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::uint32_t& data)
{
	return realSendCommand<std::int32_t>(static_cast<std::int32_t>(data));
}

template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::uint64_t& data)
{
	return realSendCommand<std::int32_t>(static_cast<std::int32_t>(data));
}

template <>
inline bool COpenZWaveNodeKeywordBase::realSendCommand(const std::int64_t& data)
{
	return realSendCommand<std::int32_t>(static_cast<std::int32_t>(data));
}
...
template <>
inline std::uint8_t COpenZWaveNodeKeywordBase::extractLastValue()
{
	std::uint8_t value;
	...
	case OpenZWave::ValueID::ValueType_Decimal:
	{
		float fv;
		OpenZWave::Manager::Get()->GetValueAsFloat(m_valueId, &fv);
		value = static_cast<std::uint8_t>(fv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_Int:
	{
		...
		int iv;
		OpenZWave::Manager::Get()->GetValueAsInt(m_valueId, &iv);
		value = static_cast<std::uint8_t>(iv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_Short:
	{
		...
		short sv;
		OpenZWave::Manager::Get()->GetValueAsShort(m_valueId, &sv);
		value = static_cast<std::uint8_t>(sv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_String:
	{
		...
		std::string stv;
		OpenZWave::Manager::Get()->GetValueAsString(m_valueId, &stv);
		value = boost::lexical_cast<std::uint8_t>(stv);
		break;
	}
...
template <>
inline std::int32_t COpenZWaveNodeKeywordBase::extractLastValue()
{
	std::int32_t value;
	...
	case OpenZWave::ValueID::ValueType_Decimal:
	{
		float fv;
		OpenZWave::Manager::Get()->GetValueAsFloat(m_valueId, &fv);
		value = static_cast<std::int32_t>(fv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_Short:
	{
		short sv;
		OpenZWave::Manager::Get()->GetValueAsShort(m_valueId, &sv);
		value = static_cast<std::int32_t>(sv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_String:
	{
		std::string stv;
		OpenZWave::Manager::Get()->GetValueAsString(m_valueId, &stv);
		value = boost::lexical_cast<std::int32_t>(stv);
		break;
	}
...
template <>
inline std::int16_t COpenZWaveNodeKeywordBase::extractLastValue()
{
	std::int16_t value;
	...
	case OpenZWave::ValueID::ValueType_Decimal:
	{
		float fv;
		OpenZWave::Manager::Get()->GetValueAsFloat(m_valueId, &fv);
		value = static_cast<std::int16_t>(fv);
		break;
	}
	...
	case OpenZWave::ValueID::ValueType_String:
	{
		std::string stv;
		OpenZWave::Manager::Get()->GetValueAsString(m_valueId, &stv);
		value = boost::lexical_cast<std::int16_t>(stv);
		break;
	}
