...
boost::shared_ptr<IOpenZWaveNodeKeyword> COpenZWaveNodeKeywordFactory::createKeyword(OpenZWave::ValueID& vID, std::uint32_t homeId, std::uint8_t nodeId, bool includeSystemKeywords)
{
	return generateHistoriser(vID, homeId, nodeId, includeSystemKeywords);
}


boost::shared_ptr<IOpenZWaveNodeKeyword> COpenZWaveNodeKeywordFactory::generateHistoriser(OpenZWave::ValueID& vID, std::uint32_t homeId, std::uint8_t nodeId, bool includeSystemKeywords)
{
	try
	{
...
boost::shared_ptr<IOpenZWaveNodeKeyword> COpenZWaveNodeKeywordFactory::generateStandardKeyword(const std::string& vLabel, OpenZWave::ValueID& vID, shared::plugin::yPluginApi::EKeywordAccessMode accessMode, const ECommandClass& commandClass)
{
	...
	case ECommandClass::kBatteryValue:
		if (vLabel == "Battery Level")
		{
			...
			return COpenZWaveNodeKeywordGeneric<std::int32_t>::create(historizer, vID);
		}
		break;
	...
	case ECommandClass::kMeterValue:
		...
		if (vLabel == "Count")
		{
			...
			return COpenZWaveNodeKeywordGeneric<std::int64_t>::create(historizer, vID);
		}
		if (vLabel == "Voltage")
		{
			CDecimalTypeInfo ti(vID);
...
boost::shared_ptr<IOpenZWaveNodeKeyword> COpenZWaveNodeKeywordFactory::generateSpecificKeyword(const std::string& vLabel, const std::string& units, OpenZWave::ValueID& vID, shared::plugin::yPluginApi::EKeywordAccessMode accessMode)
{
	...
	{
		CIntegerTypeInfo ti(vID);
		return COpenZWaveNodeKeywordGeneric<std::uint8_t>::createFromDataType(vID, vLabel, accessMode, units, shared::plugin::yPluginApi::EKeywordDataType::kNumeric, shared::plugin::yPluginApi::EMeasureType::kAbsolute, ti);
	}
	...
	{
		CIntegerTypeInfo ti(vID);
		return COpenZWaveNodeKeywordGeneric<std::int32_t>::createFromDataType(vID, vLabel, accessMode, units, shared::plugin::yPluginApi::EKeywordDataType::kNumeric, shared::plugin::yPluginApi::EMeasureType::kAbsolute, ti);
	}
	...
	case OpenZWave::ValueID::ValueType_Short: // 16-bit signed value
	{
		...
		if (max > 32767)
			return COpenZWaveNodeKeywordGeneric<std::uint16_t>::createFromDataType(vID, vLabel, accessMode, units, shared::plugin::yPluginApi::EKeywordDataType::kNumeric, shared::plugin::yPluginApi::EMeasureType::kAbsolute, ti);
		return COpenZWaveNodeKeywordGeneric<std::int16_t>::createFromDataType(vID, vLabel, accessMode, units, shared::plugin::yPluginApi::EKeywordDataType::kNumeric, shared::plugin::yPluginApi::EMeasureType::kAbsolute, ti);
	}
