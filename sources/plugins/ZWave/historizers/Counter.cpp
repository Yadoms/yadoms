...
namespace historizers
{
	CCounter::CCounter(const std::string& name, shared::plugin::yPluginApi::EKeywordAccessMode accessMode, CIntegerTypeInfo& ti)
		: COpenZWaveSingleHistorizableData<std::int64_t>(boost::make_shared<shared::plugin::yPluginApi::historization::CCounter>(name, accessMode, shared::plugin::yPluginApi::EMeasureType::kCumulative, ti))
	{
	}
	...
	CCounter::CCounter(const std::string& name, shared::plugin::yPluginApi::EKeywordAccessMode accessMode, shared::plugin::yPluginApi::EMeasureType measureType, CIntegerTypeInfo& ti)
		: COpenZWaveSingleHistorizableData<std::int64_t>(boost::make_shared<shared::plugin::yPluginApi::historization::CCounter>(name, accessMode, measureType, ti))
	{
	}
