...
{
public:
   static boost::shared_ptr<IOpenZWaveNodeKeyword> createKeyword(OpenZWave::ValueID& vID, std::uint32_t homeId, std::uint8_t nodeId, bool includeSystemKeywords);
...
private:
   static boost::shared_ptr<IOpenZWaveNodeKeyword> generateHistoriser(OpenZWave::ValueID& vID, std::uint32_t homeId, std::uint8_t nodeId, bool includeSystemKeywords);
