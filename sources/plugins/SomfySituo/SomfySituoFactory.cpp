...
boost::shared_ptr<shared::communication::IAsyncPort> CSomfySituoFactory::constructPort(
...
boost::shared_ptr<CSomfySituoReceiveBufferHandler> CSomfySituoFactory::GetBufferHandler(
   shared::event::CEventHandler& eventHandler,
