...
public:
   ...
   void setHook(boost::function<bool(const message::CEsp3ReceivedPacket&)> isExpectedMessageFct,
...
private:
   ...
   boost::function<bool(const message::CEsp3ReceivedPacket&)> m_isExpectedMessageHookFct;
   boost::function<void(const message::CEsp3ReceivedPacket&)> m_onReceiveHookFct;
