...
{
   //--------------------------------------------------------------
   /// \brief	The energy protocol support (reception only)
   //--------------------------------------------------------------
   class CEnergy : public IRfxcomMessage
   {
   public:
      //--------------------------------------------------------------
      /// \brief	                        Constructor
      ...
      //--------------------------------------------------------------
      CEnergy(boost::shared_ptr<yApi::IYPluginApi> api, const RBUF& rbuf, size_t rbufSize, boost::shared_ptr<const ISequenceNumberProvider> seqNumberProvider);
