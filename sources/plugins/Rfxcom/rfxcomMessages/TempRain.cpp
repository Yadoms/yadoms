...
namespace rfxcomMessages
{
   CTempRain::CTempRain(boost::shared_ptr<yApi::IYPluginApi> api,
      ...
      m_keywords({ m_temperature , m_rain, m_batteryLevel , m_signalStrength })
   {
      ...
      m_signalStrength->set(NormalizesignalStrengthLevel(rbuf.TEMP_RAIN.signalStrength));
   ...
   boost::shared_ptr<std::queue<shared::communication::CByteBuffer> > CTempRain::encode(boost::shared_ptr<ISequenceNumberProvider> seqNumberProvider) const
   {
