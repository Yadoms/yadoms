...
namespace rfxcomMessages
{
   CPower::CPower(boost::shared_ptr<yApi::IYPluginApi> api,
      ...
      m_keywords({ m_voltage , m_current , m_instantPower , m_totalPower , m_powerFactor , m_frequency , m_signalStrength })
   {
      ...
      m_signalStrength->set(NormalizesignalStrengthLevel(rbuf.POWER.signalStrength));
