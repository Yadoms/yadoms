...
namespace rfxcomMessages
{
   CCurrentEnergy::CCurrentEnergy(boost::shared_ptr<yApi::IYPluginApi> api,
      ...
      m_keywords({ m_current1 , m_current2, m_current3, m_instantPower , m_batteryLevel, m_signalStrength })
   {
      ...
      m_signalStrength->set(NormalizesignalStrengthLevel(rbuf.CURRENT_ENERGY.signalStrength));
