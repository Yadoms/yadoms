...
namespace rfxcomMessages
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      CLighting3(boost::shared_ptr<yApi::IYPluginApi> api, const std::string& command, const shared::CDataContainer& deviceDetails);
      ...
      //--------------------------------------------------------------
      CLighting3(boost::shared_ptr<yApi::IYPluginApi> api, unsigned char subType, const shared::CDataContainer& manuallyDeviceCreationConfiguration);
      ...
      //--------------------------------------------------------------
      CLighting3(boost::shared_ptr<yApi::IYPluginApi> api, const RBUF& rbuf, size_t rbufSize, boost::shared_ptr<const ISequenceNumberProvider> seqNumberProvider);
