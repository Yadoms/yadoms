...
{
   CRFXSensor::CRFXSensor(boost::shared_ptr<yApi::IYPluginApi> context,
                          const RBUF& rbuf,
                          size_t rbufSize,
   ...
   void CRFXSensor::processMessage(unsigned int msgId)
   {
      switch (msgId)
      {
      case 0x0001: YADOMS_LOG(warning) << "RFXSensor received message \"Sensor addresses incremented\"";
         break;
      case 0x0002: YADOMS_LOG(warning) << "RFXSensor received message \"Battery low detected\"";
         break;
      case 0x0081: YADOMS_LOG(warning) << "RFXSensor received message \"No 1-wire device connected\"";
         break;
      case 0x0082: YADOMS_LOG(warning) << "RFXSensor received message \"1-Wire ROM CRC error\"";
         break;
      case 0x0083: YADOMS_LOG(warning) << "RFXSensor received message \"1-Wire device connected is not a DS18B20 or DS2438\"";
         break;
      case 0x0084: YADOMS_LOG(warning) << "RFXSensor received message \"No end of read signal received from 1-Wiredevice\"";
         break;
      case 0x0085: YADOMS_LOG(warning) << "RFXSensor received message \"1-Wire scratchpad CRC error\"";
         break;
      default: YADOMS_LOG(warning) << "RFXSensor invalid received message (unknown ID " << msgId << ")" ;
         break;
      }
   }
} // namespace rfxcomMessages
