...
class CGamutA : public ILight
{
public:

   CGamutA(boost::shared_ptr<CUrlManager>& urlManager, std::pair<int, CHueLightInformations>& lightInformations);
   virtual ~CGamutA() = default;
