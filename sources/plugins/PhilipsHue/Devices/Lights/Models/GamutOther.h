...
class CGamutOther : public ILight
{
public:

   CGamutOther(boost::shared_ptr<CUrlManager>& urlManager, std::pair<int, CHueLightInformations>& lightInformations);
   virtual ~CGamutOther() = default;
