...
std::map<int, CHueLightInformations> CLightsService::getAllLights()
{
   ...
   try
   {
      ...
      while (response->exists(std::to_string(lightCounter)))
      {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kType.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kType.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kName.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kName.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kModelId.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kModelId.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kManufacturerName.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kManufacturerName.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kProductName.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kProductName.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kUniqueId.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kUniqueId.toString()))
         {
            hueLightInformations.setUniqueId(
               response->get<std::string>(
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kSwVersion.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kSwVersion.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kSwConfigId.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kSwConfigId.toString()))
         {
         ...
         if (response->exists(std::to_string(lightCounter) + "." + EHueLightResponseType::kProductId.toString()) &&
             !response->isNull(std::to_string(lightCounter) + "." + EHueLightResponseType::kProductId.toString()))
         {
   ...
   {
      const auto message =
         (boost::format("Fail to send Get http request or interpret answer \"%1%\" : %2%") % lightUrl % e.what()).str();
...
CHueLightInformations CLightsService::getLightAttributesAndState(const int id)
{
   ...
   try
   {
      ...
      if (response->exists(EHueLightResponseType::kType.toString()) &&
          !response->isNull(EHueLightResponseType::kType.toString()))
      {
      ...
      if (response->exists(EHueLightResponseType::kName.toString()) &&
          !response->isNull(EHueLightResponseType::kName.toString()))
      {
         hueLightAttributesAndState.setName(response->get<std::string>(EHueLightResponseType::kName.toString()));
      }

      if (response->exists(EHueLightResponseType::kModelId.toString()) &&
          !response->isNull(EHueLightResponseType::kModelId.toString()))
      {
         hueLightAttributesAndState.setModelId(response->get<std::string>(EHueLightResponseType::kModelId.toString()));
      }

      if (response->exists(EHueLightResponseType::kManufacturerName.toString()) &&
          !response->isNull(EHueLightResponseType::kManufacturerName.toString()))
      {
         hueLightAttributesAndState.setManufacturerName(
            response->get<std::string>(EHueLightResponseType::kManufacturerName.toString()));
      }

      if (response->exists(EHueLightResponseType::kProductName.toString()) &&
          !response->isNull(EHueLightResponseType::kProductName.toString()))
      {
      ...
      if (response->exists(EHueLightResponseType::kUniqueId.toString()) &&
          !response->isNull(EHueLightResponseType::kUniqueId.toString()))
      {
         hueLightAttributesAndState.setUniqueId(response->get<std::string>(EHueLightResponseType::kUniqueId.toString()));
      }

      if (response->exists(EHueLightResponseType::kSwVersion.toString()) &&
          !response->isNull(EHueLightResponseType::kSwVersion.toString()))
      {
         hueLightAttributesAndState.setSwVersion(
            response->get<std::string>(EHueLightResponseType::kSwVersion.toString()));
      }

      if (response->exists(EHueLightResponseType::kSwConfigId.toString()) &&
          !response->isNull(EHueLightResponseType::kSwConfigId.toString()))
      {
         hueLightAttributesAndState.setSwConfigId(
            response->get<std::string>(EHueLightResponseType::kSwConfigId.toString()));
      }

      if (response->exists(EHueLightResponseType::kProductId.toString()) &&
          !response->isNull(EHueLightResponseType::kProductId.toString()))
      {
...
{
   CHueState state;
   if (response->exists(EHueLightResponseType::kStateOn.toString()) && !response->isNull(EHueLightResponseType::kStateOn.toString()))
      state.setOn(response->get<bool>(EHueLightResponseType::kStateOn.toString()));
   if (response->exists(EHueLightResponseType::kStateBri.toString()) && !response->isNull(EHueLightResponseType::kStateBri.toString()))
      state.setBri(response->get<int>(EHueLightResponseType::kStateBri.toString()));
   if (response->exists(EHueLightResponseType::kStateHue.toString()) && !response->isNull(EHueLightResponseType::kStateHue.toString()))
      state.setHue(response->get<int>(EHueLightResponseType::kStateHue.toString()));
   if (response->exists(EHueLightResponseType::kStateSat.toString()) && !response->isNull(EHueLightResponseType::kStateSat.toString()))
      state.setSat(response->get<int>(EHueLightResponseType::kStateSat.toString()));
   if (response->exists(EHueLightResponseType::kStateEffect.toString()) && !response->isNull(EHueLightResponseType::kStateEffect.toString()))
      state.setEffect(response->get<std::string>(EHueLightResponseType::kStateEffect.toString()));

   CXy xy;
   if (response->exists(EHueLightResponseType::kStateXyX.toString()) && !response->isNull(EHueLightResponseType::kStateXyX.toString()))
      xy.setX(response->get<float>(EHueLightResponseType::kStateXyX.toString()));
   if (response->exists(EHueLightResponseType::kStateXyY.toString()) && !response->isNull(EHueLightResponseType::kStateXyY.toString()))
      xy.setY(response->get<float>(EHueLightResponseType::kStateXyY.toString()));
   state.setXy(xy);

   if (response->exists(EHueLightResponseType::kStateCt.toString()) && !response->isNull(EHueLightResponseType::kStateCt.toString()))
      state.setCt(response->get<int>(EHueLightResponseType::kStateCt.toString()));

   if (response->exists(EHueLightResponseType::kStateAlert.toString()) && !response->isNull(EHueLightResponseType::kStateAlert.toString()))
      state.setAlert(response->get<std::string>(EHueLightResponseType::kStateAlert.toString()));

   if (response->exists(EHueLightResponseType::kStateColorMode.toString()) && !response->isNull(EHueLightResponseType::kStateColorMode.toString()))
      state.setColorMode(response->get<std::string>(EHueLightResponseType::kStateColorMode.toString()));

   if (response->exists(EHueLightResponseType::kStateMode.toString()) && !response->isNull(EHueLightResponseType::kStateMode.toString()))
      state.setMode(response->get<std::string>(EHueLightResponseType::kStateMode.toString()));

   if (response->exists(EHueLightResponseType::kStateReachable.toString()) && !response->isNull(EHueLightResponseType::kStateReachable.toString()))
...
CHueSwUpdate CLightsService::getHueLightInformationsSwUpdate(boost::shared_ptr<shared::CDataContainer>& response)
{
   ...
   if (response->exists(EHueLightResponseType::kSwUpdateState.toString()) && !response->isNull(EHueLightResponseType::kSwUpdateState.toString()))
      swUpdate.setState(response->get<std::string>(EHueLightResponseType::kSwUpdateState.toString()));
   if (response->exists(EHueLightResponseType::kSwUpdateLastInstall.toString()) && !response->isNull(EHueLightResponseType::kSwUpdateLastInstall.toString()))
...
CHueCapabilities CLightsService::getHueLightInformationsCapabilities(boost::shared_ptr<shared::CDataContainer>& response)
{
   ...
   if (response->exists(EHueLightResponseType::kCapabilitiesCertified.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesCertified.toString()))
      capabilities.setCertified(response->get<bool>(EHueLightResponseType::kCapabilitiesCertified.toString()));

   CHueControl control;
   if (response->exists(EHueLightResponseType::kCapabilitiesControlMinDimLevel.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesControlMinDimLevel.toString()))
      control.setMinDimLevel(response->get<int>(EHueLightResponseType::kCapabilitiesControlMinDimLevel.toString()));
   if (response->exists(EHueLightResponseType::kCapabilitiesControlMaxLumen.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesControlMaxLumen.toString()))
      control.setMaxLumen(response->get<int>(EHueLightResponseType::kCapabilitiesControlMaxLumen.toString()));
   if (response->exists(EHueLightResponseType::kCapabilitiesControlColorGamutType.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesControlColorGamutType.toString()))
      control.setColorGamutType(response->get<std::string>(EHueLightResponseType::kCapabilitiesControlColorGamutType.toString()));
   //TODO : fill COLORGAMUT
   CHueCt ct;
   if (response->exists(EHueLightResponseType::kCapabilitiesControlCtMin.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesControlCtMin.toString()))
      ct.setMin(response->get<int>(EHueLightResponseType::kCapabilitiesControlCtMin.toString()));
   if (response->exists(EHueLightResponseType::kCapabilitiesControlCtMax.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesControlCtMax.toString()))
   ...
   if (response->exists(EHueLightResponseType::kCapabilitiesStreamingRenderer.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesStreamingRenderer.toString()))
      streaming.setRenderer(response->get<bool>(EHueLightResponseType::kCapabilitiesStreamingRenderer.toString()));
   if (response->exists(EHueLightResponseType::kCapabilitiesStreamingProxy.toString()) && !response->isNull(EHueLightResponseType::kCapabilitiesStreamingProxy.toString()))
...
{
   boost::asio::steady_timer timer(m_io, boost::asio::chrono::seconds(40));
