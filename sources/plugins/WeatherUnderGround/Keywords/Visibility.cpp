...
CVisibility::CVisibility( std::string PluginName, std::string KeyWordName )
   :m_PluginName ( PluginName ), m_visibility( new yApi::historization::CDistance(KeyWordName) )
{}
...
boost::shared_ptr<yApi::historization::IHistorizable> CVisibility::GetHistorizable() const
{
	return m_visibility;
}