...
#include "../hardCoded\Profile_D2_01_11.h"
#include "../hardCoded\Profile_D2_01_08.h"
#include "../hardCoded\Profile_D2_01_10.h"
...
#include "../hardCoded\Profile_D2_01_0C.h"
...
#include "../hardCoded\Profile_D2_01_0B.h"
...
boost::shared_ptr<IType> CVLD_0x01::createType(unsigned int typeId, const std::string& deviceId, boost::shared_ptr<yApi::IYPluginApi> api) const {
   ...
   case k0x0B: return boost::make_shared<CProfile_D2_01_0B>(deviceId, api);
   case k0x0C: return boost::make_shared<CProfile_D2_01_0C>(deviceId, api);
   ...
   case k0x10: return boost::make_shared<CProfile_D2_01_10>(deviceId, api);
   case k0x11: return boost::make_shared<CProfile_D2_01_11>(deviceId, api);
