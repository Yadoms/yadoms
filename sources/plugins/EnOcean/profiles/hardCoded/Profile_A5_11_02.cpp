...
CProfile_A5_11_02::CProfile_A5_11_02(const std::string& deviceId,
   ...
   : m_api(api),
     m_deviceId(deviceId),
     m_controllerValue(boost::make_shared<yApi::historization::CDimmable>("ControllerValue")),
     ...
     m_alarm(boost::make_shared<yApi::historization::CSwitch>("Alarm")),
     m_controllerModeHeating(boost::make_shared<yApi::historization::CSwitch>("ControllerModeHeating")),
     m_controllerModeHCooling(boost::make_shared<yApi::historization::CSwitch>("ControllerModeHCooling")),
     m_controllerStateOverriden(boost::make_shared<yApi::historization::CSwitch>("ControllerStateOverriden")),
     m_energyHoldOff(boost::make_shared<yApi::historization::CSwitch>("EnergyHoldOff")),
