...
enum class E_A5_09_0C_ScaleMultiplier
{
...
{
   static const std::string Title(R"(Gas sensor - VOC sensor)");
   return Title;
}
                                                                                                   ...
                                                                                                   boost::shared_ptr<IMessageHandler> messageHandler)
{
   ...
   switch (multiplier)
   {
   case E_A5_09_0C_ScaleMultiplier::kA5_09_0C_Multiplier_0_01:
      concentration *= 0.01;
      break;
   case E_A5_09_0C_ScaleMultiplier::kA5_09_0C_Multiplier_0_1:
      concentration *= 0.1;
      break;
   case E_A5_09_0C_ScaleMultiplier::kA5_09_0C_Multiplier_1:
      concentration *= 1.0;
      break;
   case E_A5_09_0C_ScaleMultiplier::kA5_09_0C_Multiplier_10:
      concentration *= 10.0;
      break;
   }
