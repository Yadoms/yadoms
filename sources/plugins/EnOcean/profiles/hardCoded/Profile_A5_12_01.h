...
private:
   static const int NB_TARIFF_INFO = 16;
   const std::string m_deviceId;
   boost::shared_ptr<yApi::historization::CEnergy> m_energy[NB_TARIFF_INFO];
   boost::shared_ptr<yApi::historization::CPower> m_instantPower[NB_TARIFF_INFO];
