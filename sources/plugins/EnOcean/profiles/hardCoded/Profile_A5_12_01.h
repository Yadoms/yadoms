...
public:
   ...
   ~CProfile_A5_12_01() override = default;
...
private:
   ...
   boost::shared_ptr<yApi::historization::CEnergy> m_energy[NbTariffs];
   boost::shared_ptr<yApi::historization::CPower> m_instantPower[NbTariffs];
