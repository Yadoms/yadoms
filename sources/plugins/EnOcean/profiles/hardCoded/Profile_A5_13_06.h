...
{
public:
   CProfile_A5_13_06(const std::string& deviceId,
                     boost::shared_ptr<yApi::IYPluginApi> api);
   ~CProfile_A5_13_06() override = default;
...
private:
   boost::shared_ptr<yApi::historization::CDirectionDouble> m_latitude;
   boost::shared_ptr<yApi::historization::CDirectionDouble> m_longitude;
