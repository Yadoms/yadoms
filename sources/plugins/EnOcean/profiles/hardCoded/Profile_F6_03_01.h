...
{
public:
   CProfile_F6_03_01(const std::string& deviceId,
                     boost::shared_ptr<yApi::IYPluginApi> api);
   ~CProfile_F6_03_01() override = default;
...
private:
   boost::shared_ptr<yApi::historization::CSwitch> m_buttonA, m_buttonB, m_buttonC, m_buttonD;
