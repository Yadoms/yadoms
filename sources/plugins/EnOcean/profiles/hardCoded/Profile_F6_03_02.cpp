#include "stdafx.h"
#include "Profile_F6_03_02.h"
#include "../bitsetHelpers.hpp"
#include <shared/Log.h>

CProfile_F6_03_02::CProfile_F6_03_02(const std::string& deviceId,
...
const std::string& CProfile_F6_03_02::profile() const
{
   static const std::string Profile("F6-03-02");
   return Profile;
}

const std::string& CProfile_F6_03_02::title() const
{
   static const std::string Title(R"(Rocker switch, 4 rocker - Light and Blind Control - Application style 2)");
   return Title;
}

std::vector<boost::shared_ptr<const yApi::historization::IHistorizable>> CProfile_F6_03_02::allHistorizers() const
{
   return m_historizers;
}

void CProfile_F6_03_02::readInitialState(const std::string& senderId,
                                         boost::shared_ptr<IMessageHandler> messageHandler)
{
   // Read-only device
}

std::vector<boost::shared_ptr<const yApi::historization::IHistorizable>> CProfile_F6_03_02::states(
   unsigned char rorg,
   ...
   boost::shared_ptr<IMessageHandler> messageHandler)
{
   ...
   case 7:
      ...
      break;
   default:
      YADOMS_LOG(error) << "Profile F6_03_02 : receive unsupported rocker first action value " << rocker1stAction;
      break;
   }
   ...
   if (secondAction)
   {
      ...
      case 7:
         ...
         break;
      default:
         YADOMS_LOG(error) << "Profile F6_03_02 : receive unsupported rocker second action value " << rocker2ndAction;
         break;
      }
   }
...
void CProfile_F6_03_02::sendCommand(const std::string& keyword,
...
void CProfile_F6_03_02::sendConfiguration(const shared::CDataContainer& deviceConfiguration,
                                          const std::string& senderId,
                                          boost::shared_ptr<IMessageHandler> messageHandler)
{
