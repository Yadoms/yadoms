                                                                                                   ...
                                                                                                   const boost::dynamic_bitset<>& status) const
{
   ...
   case 3:
      ...
      break;
   default:
      std::cerr << "Profile F6_02_01 : receive unsupported rocker first action value " << rocker1stAction << std::endl;
      break;
   }
   ...
   if (secondAction)
   {
      ...
      case 3:
         ...
         break;
      default:
         std::cerr << "Profile F6_02_01 : receive unsupported rocker second action value " << rocker2ndAction << std::endl;
         break;
      }
   }
