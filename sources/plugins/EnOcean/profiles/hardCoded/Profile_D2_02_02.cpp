...
CProfile_D2_02_02::CProfile_D2_02_02(std::string deviceId,
   ...
   : m_deviceId(std::move(deviceId)),
     ...
     m_smoke(boost::make_shared<yApi::historization::CSwitch>("Smoke",
                                                              yApi::EKeywordAccessMode::kGet)),
     m_historizers({m_temperature, m_smoke})
{
}

const std::string& CProfile_D2_02_02::profile() const
{
   static const std::string Profile("D2-02-02");
   return Profile;
}

const std::string& CProfile_D2_02_02::title() const
{
   static const std::string Title("Sensors for Temperature And Smoke");
   return Title;
}

std::vector<boost::shared_ptr<const yApi::historization::IHistorizable>> CProfile_D2_02_02::allHistorizers() const
{
...
std::vector<boost::shared_ptr<const yApi::historization::IHistorizable>> CProfile_D2_02_02::states(
   unsigned char rorg,
   ...
   boost::shared_ptr<IMessageHandler> messageHandler)
{
   ...
   switch (static_cast<EMeasurementType>(bitset_extract(data, 8, 3)))  // NOLINT(clang-diagnostic-switch-enum)
   {
