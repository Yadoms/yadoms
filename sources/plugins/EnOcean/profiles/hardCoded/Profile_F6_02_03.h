...
{
public:
   CProfile_F6_02_03(const std::string& deviceId,
                     boost::shared_ptr<yApi::IYPluginApi> api);
   ~CProfile_F6_02_03() override = default;
...
private:
   boost::shared_ptr<yApi::historization::CSwitch> m_autoMode, m_upDown;
   boost::shared_ptr<yApi::historization::CEvent> m_manualOnOff;
