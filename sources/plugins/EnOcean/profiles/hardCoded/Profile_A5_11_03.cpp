...
CProfile_A5_11_03::CProfile_A5_11_03(const std::string& deviceId,
   ...
   : m_api(api),
     ...
     m_curtain(boost::make_shared<yApi::historization::CCurtain>("BlindCurrentPosition", yApi::EKeywordAccessMode::kGet)),
     m_currentMovement(boost::make_shared<yApi::historization::CCurtain>("BlindCurrentMovement", yApi::EKeywordAccessMode::kGet)),
     m_serviceMode(boost::make_shared<yApi::historization::CSwitch>("ServiceModeActivated", yApi::EKeywordAccessMode::kGet)),
     m_inverseMode(boost::make_shared<yApi::historization::CSwitch>("InverseMode", yApi::EKeywordAccessMode::kGet)),
     m_historizers({
