...
{
   static const std::string Title(R"(Wind Speed Threshold Detector)");
   return Title;
}
...
std::vector<boost::shared_ptr<const yApi::historization::IHistorizable>> CProfile_F6_05_00::states(
   unsigned char rorg,
