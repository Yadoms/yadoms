...
namespace message
{
    CDongleVersionResponseReceivedMessage::Version::Version(const unsigned main,
                                                            const unsigned beta,
    ...
    CDongleVersionResponseReceivedMessage::CDongleVersionResponseReceivedMessage(const CResponseReceivedMessage& response)
