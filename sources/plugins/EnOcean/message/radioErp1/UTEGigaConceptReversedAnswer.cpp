#include "stdafx.h"
#include "UTEGigaConceptReversedAnswer.h"
#include <profiles/bitsetHelpers.hpp>

using namespace message::radioErp1;

CUTEGigaConceptReversedAnswer::CUTEGigaConceptReversedAnswer(const std::string& senderId,
...
CUTEGigaConceptReversedAnswer::~CUTEGigaConceptReversedAnswer()
{
}

boost::shared_ptr<const std::vector<unsigned char>> CUTEGigaConceptReversedAnswer::buffer()
{
