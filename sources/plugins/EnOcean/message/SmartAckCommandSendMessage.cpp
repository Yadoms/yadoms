...
namespace message
{
    CSmartAckCommandSendMessage::CSmartAckCommandSendMessage(const ESmartAckCommand command,
    ...
    boost::shared_ptr<const std::vector<unsigned char>> CSmartAckCommandSendMessage::buffer()
    {
