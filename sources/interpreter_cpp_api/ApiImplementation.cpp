...
namespace interpreter_cpp_api
{
                                      ...
                                      size_t messageSize)
   {
      ...
      interpreter_IPC::toInterpreter::msg toPluginProtoBuffer;
      ...
      {
      case interpreter_IPC::toInterpreter::msg::kSystem: processSystem(toPluginProtoBuffer.system());
         break;
      case interpreter_IPC::toInterpreter::msg::kUpdateConfiguration: processUpdateConfiguration(toPluginProtoBuffer.updateconfiguration());
         break;
      case interpreter_IPC::toInterpreter::msg::kBindingQuery: processBindingQuery(toPluginProtoBuffer.bindingquery());
         break;
      case interpreter_IPC::toInterpreter::msg::kDeviceCommand: processDeviceCommand(toPluginProtoBuffer.devicecommand());
         break;
      case interpreter_IPC::toInterpreter::msg::kExtraQuery: processExtraQuery(toPluginProtoBuffer.extraquery());
         break;
      case interpreter_IPC::toInterpreter::msg::kDeviceConfigurationSchemaRequest: processDeviceConfigurationSchemaRequest(toPluginProtoBuffer.deviceconfigurationschemarequest());
         break;
      case interpreter_IPC::toInterpreter::msg::kSetDeviceConfiguration: processSetDeviceConfiguration(toPluginProtoBuffer.setdeviceconfiguration());
         break;
      case interpreter_IPC::toInterpreter::msg::kManuallyDeviceCreation: processManuallyDeviceCreation(toPluginProtoBuffer.manuallydevicecreation());
         break;
      case interpreter_IPC::toInterpreter::msg::kDeviceRemoved: processDeviceRemoved(toPluginProtoBuffer.deviceremoved());
         break;
      default:
   ...
   {
      m_pluginInformation = boost::make_shared<CPluginInformation>(boost::make_shared<const interpreter_IPC::toInterpreter::Information>(msg.plugininformation()));
      m_dataPath = boost::make_shared<const boost::filesystem::path>(msg.datapath());
      setInitialized();
   }

   void CApiImplementation::processUpdateConfiguration(const interpreter_IPC::toInterpreter::Configuration& msg)
   {
   ...
   void CApiImplementation::processBindingQuery(const interpreter_IPC::toInterpreter::BindingQuery& msg)
   {
   ...
   void CApiImplementation::processDeviceConfigurationSchemaRequest(const interpreter_IPC::toInterpreter::DeviceConfigurationSchemaRequest& msg)
   {
   ...
   void CApiImplementation::processSetDeviceConfiguration(const interpreter_IPC::toInterpreter::SetDeviceConfiguration& msg)
   {
   ...
   void CApiImplementation::processDeviceCommand(const interpreter_IPC::toInterpreter::DeviceCommand& msg)
   {
   ...
   void CApiImplementation::processExtraQuery(const interpreter_IPC::toInterpreter::ExtraQuery& msg)
   {
   ...
   void CApiImplementation::processManuallyDeviceCreation(const interpreter_IPC::toInterpreter::ManuallyDeviceCreation& msg)
   {
   ...
   void CApiImplementation::processDeviceRemoved(const interpreter_IPC::toInterpreter::DeviceRemoved& msg)
   {
                                           ...
                                           const std::map<std::string, std::string>& customMessageDataParams)
   {
      ...
      switch (state)
      {
      case shared::plugin::yPluginApi::historization::EPluginState::kUnknownValue: request->set_pluginstate(interpreter_IPC::toYadoms::SetPluginState_EPluginState_kUnknown);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kErrorValue: request->set_pluginstate(interpreter_IPC::toYadoms::SetPluginState_EPluginState_kError);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kStoppedValue: request->set_pluginstate(interpreter_IPC::toYadoms::SetPluginState_EPluginState_kStopped);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kRunningValue: request->set_pluginstate(interpreter_IPC::toYadoms::SetPluginState_EPluginState_kRunning);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kCustomValue: request->set_pluginstate(interpreter_IPC::toYadoms::SetPluginState_EPluginState_kCustom);
         break;
      default:
   ...
   std::vector<std::string> CApiImplementation::getAllDevices() const
   {
      ...
      {
         send(req,
              [](const interpreter_IPC::toInterpreter::msg& ans) -> bool
              {
                 return ans.has_alldevicesanswer();
              },
              [&](const interpreter_IPC::toInterpreter::msg& ans) -> void
              {
   ...
   {
      interpreter_IPC::toYadoms::msg msg;
