...
CApiImplementation::CApiImplementation(const std::string& yScriptApiAccessorId)
{
...
void CApiImplementation::sendRequest(const pbRequest::msg& request) const
{
   try
   {
...
void CApiImplementation::receiveAnswer(pbAnswer::msg& answer) const
{
   // Wait answer
