...
namespace plugin_cpp_api
{
   ...
   void CApiImplementation::setSendingMessageQueue(
      const boost::shared_ptr<boost::interprocess::message_queue>& sendMessageQueue)
   {
      m_sendMessageQueue = sendMessageQueue;
      m_messageCutter = boost::make_shared<shared::communication::SmallHeaderMessageCutter>(
   ...
   void CApiImplementation::send(const plugin_IPC::toYadoms::msg& msg) const
   {
      try
      {
         ...
         if (!m_sendMessageQueue || !m_messageCutter)
            throw std::runtime_error(
               (boost::format("CApiImplementation::send \"%1%\", plugin API not ready to send message") %
                  plugin_IPC::toYadoms::msg::descriptor()->full_name())
               .str());

         if (!msg.IsInitialized())
            throw std::runtime_error(
               (boost::format("CApiImplementation::send \"%1%\", request is not fully initialized") %
                  plugin_IPC::toYadoms::msg::descriptor()->full_name()).
               str());
         ...
         if (!msg.SerializeWithCachedSizesToArray(serializedMessage.get()))
            throw std::runtime_error(
               (boost::format("CApiImplementation::send \"%1%\", fail to serialize request (too big ?)") %
                  plugin_IPC::toYadoms::msg::descriptor()->full_name()
               ).str());
      ...
      {
         throw std::runtime_error(
            (boost::format("CApiImplementation::send \"%1%\" : error :%2%") % plugin_IPC::toYadoms::msg::descriptor()->full_name() % ex.what())
            .str());
      }
   }
      ...
      case kErrorReceived:
         {
            ...
            throw std::runtime_error(
               (boost::format("Error \"%1%\" received from Yadoms when sending message %2%") % receivedEvtHandler
                                                                                               .getEventData<const
                                                                                                  plugin_IPC::
                                                                                                  toPlugin::msg>().
                                                                                               error() % msg.
      ...
      case shared::event::kTimeout:
         {
            ...
            m_onReceiveHook.clear();
            throw std::runtime_error(
               (boost::format("No answer from Yadoms when sending message %1%") % msg.OneOf_case()).str());
         }
      ...
      default:
         {
            ...
            m_onReceiveHook.clear();
            throw std::runtime_error(
               (boost::format("Invalid event received %1% when sending message %2%") % receivedEvtHandler.getEventId() %
                  msg.OneOf_case()).str());
         }
      }
   }

   void CApiImplementation::onReceive(const boost::shared_ptr<const unsigned char[]>& message,
                                      size_t messageSize)
   {
      if (messageSize < 1)
      ...
      if (!toPluginProtoBuffer.ParseFromArray(message.get(), static_cast<int>(messageSize)))
         throw shared::exception::CInvalidParameter(
            (boost::format("message : fail to parse received data into protobuf format (received buffer size is %1%)") %
               messageSize).str());
      ...
      if (!m_initialized)
      {
         if (toPluginProtoBuffer.has_init())
            ...
            throw shared::exception::CInvalidParameter(
               (boost::format("Unexpected message %1% when initialization") % toPluginProtoBuffer.OneOf_case()).str());
         return;
      }
      ...
      switch (toPluginProtoBuffer.OneOf_case()) // NOLINT(clang-diagnostic-switch-enum)
      {
      case plugin_IPC::toPlugin::msg::kSystem: processSystem(toPluginProtoBuffer.system());
         break;
      case plugin_IPC::toPlugin::msg::kUpdateConfiguration: processUpdateConfiguration(
            toPluginProtoBuffer.updateconfiguration());
         break;
      ...
      case plugin_IPC::toPlugin::msg::kExtraQuery: processExtraQuery(toPluginProtoBuffer.extraquery());
         break;
      case plugin_IPC::toPlugin::msg::kDeviceConfigurationSchemaRequest: processDeviceConfigurationSchemaRequest(
            toPluginProtoBuffer.deviceconfigurationschemarequest());
         break;
      case plugin_IPC::toPlugin::msg::kSetDeviceConfiguration: processSetDeviceConfiguration(
            toPluginProtoBuffer.setdeviceconfiguration());
         break;
      case plugin_IPC::toPlugin::msg::kManuallyDeviceCreation: processManuallyDeviceCreation(
            toPluginProtoBuffer.manuallydevicecreation());
         break;
      case plugin_IPC::toPlugin::msg::kDeviceRemoved: processDeviceRemoved(toPluginProtoBuffer.deviceremoved());
         break;
      default:
         throw shared::exception::CInvalidParameter(
            (boost::format("message : unknown message type %1%") % toPluginProtoBuffer.OneOf_case()).str());
      }
   }
   ...
   {
      m_pluginInformation = boost::make_shared<CPluginInformation>(
         boost::make_shared<const plugin_IPC::toPlugin::Information>(msg.plugininformation()));
      ...
      if (msg.has_proxysettings())
      {
         ...
         if (plugin_IPC::toPlugin::ProxySettings::GetReflection()->HasField(
            providedProxySettings,
            providedProxySettings.GetDescriptor()->FindFieldByName("host")))
         {
            ...
            if (plugin_IPC::toPlugin::ProxySettings::GetReflection()->HasField(providedProxySettings,
                                                                               providedProxySettings.GetDescriptor()->FindFieldByName("port")))
               port = static_cast<unsigned short>(providedProxySettings.port());
            if (plugin_IPC::toPlugin::ProxySettings::GetReflection()->HasField(providedProxySettings,
                                                                               providedProxySettings.GetDescriptor()->FindFieldByName("username")))
               username = providedProxySettings.username();
            if (plugin_IPC::toPlugin::ProxySettings::GetReflection()->HasField(providedProxySettings,
                                                                               providedProxySettings.GetDescriptor()->FindFieldByName("password")))
               password = providedProxySettings.password();
            if (plugin_IPC::toPlugin::ProxySettings::GetReflection()->HasField(providedProxySettings,
                                                                               providedProxySettings.GetDescriptor()->FindFieldByName("bypassRegex")))
      ...
      const boost::shared_ptr<shared::plugin::yPluginApi::IBindingQueryRequest> query =
         boost::make_shared<CBindingQuery>(msg,
                                           [&](const boost::shared_ptr<shared::CDataContainer>& r)
                                           {
                                              ...
                                              const auto answer = ans.mutable_bindingqueryanswer();
   ...
   void CApiImplementation::processDeviceConfigurationSchemaRequest(
      const plugin_IPC::toPlugin::DeviceConfigurationSchemaRequest& msg)
   {
      const boost::shared_ptr<shared::plugin::yPluginApi::IDeviceConfigurationSchemaRequest> query =
         boost::make_shared<CDeviceConfigurationSchemaRequest>(msg,
                                                               ...
                                                               {
                                                                  plugin_IPC::toYadoms::msg ans;
                                                                  const auto answer = ans.mutable_deviceconfigurationschemaanswer();
                                                                  answer->set_success(true);
                                                                  answer->set_result(r->serialize());
                                                                  send(ans);
                                                               },
   ...
   {
      const boost::shared_ptr<const shared::plugin::yPluginApi::ISetDeviceConfiguration> command = boost::make_shared<
         CSetDeviceConfiguration>(msg);
   ...
   {
      const boost::shared_ptr<const shared::plugin::yPluginApi::IDeviceCommand> command = boost::make_shared<
         CDeviceCommand>(msg);
   ...
   void CApiImplementation::processExtraQuery(const plugin_IPC::toPlugin::ExtraQuery& msg)
   {
      ...
      const boost::shared_ptr<shared::plugin::yPluginApi::IExtraQuery> command =
         boost::make_shared<CExtraQuery>(msg,
                                         ...
                                         {
                                            plugin_IPC::toYadoms::msg ans;
                                            const auto answer = ans.mutable_extraqueryanswer();
                                            answer->set_success(true);
                                            answer->set_result(r->serialize());
                                         ...
                                         {
                                            plugin_IPC::toYadoms::msg ans;
                                            const auto answer = ans.mutable_extraqueryprogress();
   ...
   void CApiImplementation::processManuallyDeviceCreation(const plugin_IPC::toPlugin::ManuallyDeviceCreation& msg)
   {
      const boost::shared_ptr<shared::plugin::yPluginApi::IManuallyDeviceCreationRequest> request =
         boost::make_shared<CManuallyDeviceCreation>(msg,
                                                     ...
                                                     {
                                                        plugin_IPC::toYadoms::msg ans;
                                                        const auto answer = ans.mutable_manuallydevicecreationanswer();
                                                     ...
                                                     [&](const std::string& errorMessage)
                                                     {
                                                        plugin_IPC::toYadoms::msg ans;
                                                        const auto answer = ans.mutable_manuallydevicecreationanswer();
                                                        const auto error = answer->mutable_error();
   ...
   {
      const boost::shared_ptr<const shared::plugin::yPluginApi::IDeviceRemoved> event = boost::make_shared<
         CDeviceRemoved>(msg);
                                           ...
                                           const std::map<std::string, std::string>& customMessageDataParams)
   {
      ...
      const auto request = req.mutable_pluginstate();
      switch (state)
      {
      case shared::plugin::yPluginApi::historization::EPluginState::kUnknownValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kUnknown);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kErrorValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kError);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kStoppedValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kStopped);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kRunningValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kRunning);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kCustomValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kCustom);
         break;
      case shared::plugin::yPluginApi::historization::EPluginState::kWaitDebuggerValue: request->set_pluginstate(
            plugin_IPC::toYadoms::SetPluginState_EPluginState_kWaitDebugger);
         break;
      default:
         throw std::out_of_range(
            (boost::format("CApiImplementation::setPluginState, unknown state %1%") % state).str());
      }
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_declaredevice();
      ...
      {
         std::cerr << "Exception " << e.what() << std::endl;
         std::cerr << "Call was : declareDevice(" << device << ", " << model << ", " << keyword->getKeyword() << ", " <<
            details->serialize() << ")" <<
            std::endl;
         throw;
      }
                                          ...
                                          boost::shared_ptr<shared::CDataContainer> details)
   {
      ...
      catch (std::exception& e)
      {
         ...
         std::for_each(keywords.begin(),
                       keywords.end(),
                       [](const boost::shared_ptr<const shared::plugin::yPluginApi::historization::IHistorizable>& keyword)
                       {
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_deviceexists();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_deviceconfigurationrequest();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_updatedeviceconfiguration();
      request->set_device(device);
      ...
      {
         std::cerr << "Exception " << e.what() << std::endl;
         std::cerr << "Call was : updateDeviceConfiguration(" << device << ", " << configuration->serialize() << ")" <<
            std::endl;
         throw;
      }
   }
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_devicedetails();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_updatedevicedetails();
      request->set_device(device);
      request->set_details(details->serialize());
      try
      {
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_devicemodelrequest();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_updatedevicemodel();
      request->set_device(device);
      request->set_model(model);
      try
      {
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_devicetyperequest();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_updatedevicetype();
      request->set_device(device);
      request->set_type(type);
      try
      {
   ...
   void CApiImplementation::updateDeviceState(const std::string& device,
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_devicestate();
      switch (state)
      {
      case shared::plugin::yPluginApi::historization::EDeviceState::kUnknownValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kUnknown);
         break;
      case shared::plugin::yPluginApi::historization::EDeviceState::kActiveValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kActive);
         break;
      case shared::plugin::yPluginApi::historization::EDeviceState::kBusyValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kBusy);
         break;
      case shared::plugin::yPluginApi::historization::EDeviceState::kAsleepValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kAsleep);
         break;
      case shared::plugin::yPluginApi::historization::EDeviceState::kDeadValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kDead);
         break;
      case shared::plugin::yPluginApi::historization::EDeviceState::kCustomValue: request->set_devicestate(
            plugin_IPC::toYadoms::SetDeviceState_EDeviceState_kCustom);
         break;
      default:
         throw std::out_of_range(
            (boost::format("CApiImplementation::updateDeviceState, unknown state %1%") % state).str());
      }
      request->set_custommessageid(customMessageId);
      request->set_device(device);
      const shared::CDataContainer dc(customMessageDataParams);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_removedevice();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_declarekeywords();
      request->set_device(device);
      for (const auto& keyword : keywords)
         fillHistorizable(keyword, request->add_keywords());
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_declarekeyword();
      request->set_device(device);
      ...
      {
         std::cerr << "Exception " << e.what() << std::endl;
         std::cerr << "Call was : declareKeyword(" << device << ", " << keyword << ", " << details->serialize() << ")"
            << std::endl;
         throw;
      }
   }
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_keywordexists();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_allkeywordsrequest();
      request->set_device(device);
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_removekeyword();
      request->set_device(device);
      request->set_keyword(keyword);
   ...
   void CApiImplementation::fillHistorizable(
      const boost::shared_ptr<const shared::plugin::yPluginApi::historization::IHistorizable>& in,
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_recipientvaluerequest();
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_findrecipientsfromfieldrequest();
      request->set_fieldname(fieldName);
      ...
      {
         std::cerr << "Exception " << e.what() << std::endl;
         std::cerr << "Call was : findRecipientsFromField(" << fieldName << ", " << expectedFieldValue << ")" << std::
            endl;
         throw;
      }
   ...
   {
      plugin_IPC::toYadoms::msg req;
      const auto request = req.mutable_recipientfieldexitsrequest();
      request->set_fieldname(fieldName);
                                             ...
                                             IHistorizable> data)
   {
      ...
      const auto message = msg.mutable_historizedata();
      message->set_device(device);
      const auto value = message->add_value();
      ...
      {
         std::cerr << "Exception " << e.what() << std::endl;
         std::cerr << "Call was : historizeData(" << device << ", { " << data->getKeyword() << ", " << data->
            formatValue() << " } )" << std::endl;
         throw;
      }
   }
                                          ...
                                          dataVect)
   {
      ...
      catch (std::exception& e)
      {
         ...
         std::for_each(dataVect.begin(),
                       dataVect.end(),
                       [](const boost::shared_ptr<const shared::plugin::yPluginApi::historization::IHistorizable>& data)
                       {
   ...
   boost::shared_ptr<const shared::plugin::information::IYadomsInformation> CApiImplementation::
