...
CRuleManager::CRuleManager(boost::shared_ptr<database::IRuleRequester> dbRequester, boost::shared_ptr<communication::ISendMessageAsync> pluginGateway,
   ...
   m_scriptFactory(new script::CFactory("scriptInterpreters", pluginGateway, configurationManager, notificationCenter, dbAcquisitionRequester, runningInformation)),
