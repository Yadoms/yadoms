...
// ManagerEvent.h
//
// Yadoms-plugin events in the plugin manager
//
#pragma once
...
namespace pluginSystem
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      CManagerEvent(ESubEventType eventId, int instanceId, const boost::shared_ptr<const shared::plugin::information::IInformation> pluginInformation, bool stopping)
      ...
      //--------------------------------------------------------------
      boost::shared_ptr<const shared::plugin::information::IInformation> getPluginInformation() const
      {
