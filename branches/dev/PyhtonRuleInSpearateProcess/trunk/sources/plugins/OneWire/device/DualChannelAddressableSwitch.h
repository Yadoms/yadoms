...
namespace device {
   ...
   public:
      ...
      //--------------------------------------------------------------
      CDualChannelAddressableSwitch(EOneWireFamily family, const std::string& id, boost::shared_ptr<yApi::IYPluginApi> context, boost::shared_ptr<ioInterfaces::IMultiSwitch> io);
