...
#include "../../../../sources/server/automation/NotificationObserverForRulesManager.h"
...
class CKeywordUpdaterMoke : public automation::condition::IKeywordUpdater, public boost::enable_shared_from_this<CKeywordUpdaterMoke>
{
public:
...
class CConditionRootUpdaterMoke : public automation::condition::IConditionRootUpdater, public boost::enable_shared_from_this<CConditionRootUpdaterMoke>
{
public:
...
BOOST_AUTO_TEST_CASE(Nominal)
{
   ...
   automation::CNotificationObserverForRulesManager observer(notificationCenter);

   const int keywordId = 3;

   boost::shared_ptr<automation::condition::IKeywordUpdater> kw3(new CKeywordUpdaterMoke(keywordId, eventHandler));
   boost::shared_ptr<automation::condition::IConditionRootUpdater> conditionRootNotifier(new CConditionRootUpdaterMoke(eventHandler));
...
BOOST_AUTO_TEST_CASE(OneConditionSeveralKeywords)
{
   ...
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw3(new CKeywordUpdaterMoke(3, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw5(new CKeywordUpdaterMoke(5, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw4_1(new CKeywordUpdaterMoke(4, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw8(new CKeywordUpdaterMoke(8, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw4_2(new CKeywordUpdaterMoke(4, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw9(new CKeywordUpdaterMoke(9, eventHandler));
   boost::shared_ptr<automation::condition::IConditionRootUpdater> conditionRootNotifier(new CConditionRootUpdaterMoke(eventHandler));
   observer.registerKeywordUpdater(kw3, conditionRootNotifier);
...
BOOST_AUTO_TEST_CASE(SeveralConditionSeveralKeywordsSeveralAcquisistions)
{
   ...
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw8(new CKeywordUpdaterMoke(8, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw4_2(new CKeywordUpdaterMoke(4, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw4_3(new CKeywordUpdaterMoke(4, eventHandler));
   boost::shared_ptr<automation::condition::IKeywordUpdater> kw9(new CKeywordUpdaterMoke(9, eventHandler));
   boost::shared_ptr<automation::condition::IConditionRootUpdater> condition1(new CConditionRootUpdaterMoke(eventHandler));
   boost::shared_ptr<automation::condition::IConditionRootUpdater> condition2(new CConditionRootUpdaterMoke(eventHandler));
   boost::shared_ptr<automation::condition::IConditionRootUpdater> condition3(new CConditionRootUpdaterMoke(eventHandler));
