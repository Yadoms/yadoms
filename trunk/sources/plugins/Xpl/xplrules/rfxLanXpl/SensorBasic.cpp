   ...
   std::vector< boost::shared_ptr<CDeviceKeyword> > CSensorBasic::identifyKeywords(xplcore::CXplMessage & msg)
   {
      ...
      if(boost::starts_with(msg.getBodyValue(m_keywordDevice), m_keywordDeviceDigimax))
      {
         ...
         if (msg.getBodyValue(m_keywordType) == m_keywordTypeSetpoint)
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeSetpoint, m_keywordTypeSetpoint, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kDecimal, yApi::CStandardUnits::DegreesCelcius, details)));
      }
      ...
      if(boost::starts_with(msg.getBodyValue(m_keywordDevice), m_keywordDeviceRfxSensor))
      {
         ...
         {
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeVoltage, m_keywordTypeVoltage, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kDecimal, yApi::CStandardUnits::Volt, details)));
         }
      ...
      {
         keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeCount, m_keywordTypeCount, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kInteger, yApi::CStandardUnits::NoUnits, details)));
      }

      //RFXLAN IO
      if(boost::starts_with(msg.getBodyValue(m_keywordDevice), m_keywordDeviceRfxLanIo))
      {
         keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeInput, m_keywordTypeInput, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kString, yApi::CStandardUnits::NoUnits, m_keywordTypeIoValues)));
      }
      ...
      {
         keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeMertik, m_keywordTypeMertik, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kString, yApi::CStandardUnits::NoUnits, m_keywordTypeMertikValues)));
      }
      ...
      if(isOregonDevice(msg))
      {
         ...
         if(boost::iequals(msg.getBodyValue(m_keywordType), m_keywordTypeStatus))
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypeStatus, m_keywordTypeStatus, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kString, yApi::CStandardUnits::NoUnits, m_keywordTypeHumidityValues)));
         ...
         {
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(msg.getBodyValue(m_keywordType), msg.getBodyValue(m_keywordType), yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kDecimal, units, details)));
         }

         if (boost::iequals(msg.getBodyValue(m_keywordType), m_keywordTypePressure))
         {
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordTypePressure, m_keywordTypePressure, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kDecimal, units, details)));
            keywords.push_back(boost::shared_ptr<CDeviceKeyword>(new CDeviceKeyword(m_keywordForecast, m_keywordForecast, yApi::IYadomsApi::kReadOnly, yApi::IYadomsApi::kString, yApi::CStandardUnits::NoUnits, m_keywordTypeForecastValues)));
         }
