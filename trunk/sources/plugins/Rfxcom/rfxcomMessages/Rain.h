...
{
   //--------------------------------------------------------------
   /// \brief	The Rain protocol support (reception only)
   //--------------------------------------------------------------
   class CRain : public IRfxcomMessage
   {
   public:
      //--------------------------------------------------------------
      /// \brief	                        Constructor
      ...
      //--------------------------------------------------------------
      CRain(boost::shared_ptr<yApi::IYPluginApi> context, const RBUF& rbuf, size_t rbufSize, boost::shared_ptr<const ISequenceNumberProvider> seqNumberProvider);
   ...
   private:
      ...
      //--------------------------------------------------------------
      /// \brief	The rain, can be incremental or cumulative keyword, depending on device
      //--------------------------------------------------------------
