...
namespace rfxcomMessages
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      CChime(boost::shared_ptr<yApi::IYadomsApi> context, const shared::CDataContainer& command, const shared::CDataContainer& deviceDetails);
      ...
      //--------------------------------------------------------------
      CChime(boost::shared_ptr<yApi::IYadomsApi> context, unsigned char subType, const shared::CDataContainer& manuallyDeviceCreationConfiguration);
