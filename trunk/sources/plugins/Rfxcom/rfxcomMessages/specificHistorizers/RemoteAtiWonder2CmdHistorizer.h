...
namespace rfxcomMessages { namespace specificHistorizers {
   ...
   //-----------------------------------------------------
   class CRemoteAtiWonder2CmdHistorizer : public shared::plugin::yadomsApi::historization::CSingleHistorizableData<ERemoteAtiWonder2Codes>
   {
   public:
      //-----------------------------------------------------
      ///\brief                     Constructor
      ...
      //-----------------------------------------------------
      CRemoteAtiWonder2CmdHistorizer(const std::string& keywordName);
