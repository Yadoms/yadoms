...
{
   //--------------------------------------------------------------
   /// \brief	The BBQ protocol support (reception only)
   //--------------------------------------------------------------
   class CBbq : public IRfxcomMessage
   {
   public:
      //--------------------------------------------------------------
      /// \brief	                        Constructor
      ...
      //--------------------------------------------------------------
      CBbq(boost::shared_ptr<yApi::IYPluginApi> context, const RBUF& rbuf, size_t rbufSize, boost::shared_ptr<const ISequenceNumberProvider> seqNumberProvider);
