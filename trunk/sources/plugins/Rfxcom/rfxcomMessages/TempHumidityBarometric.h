...
namespace rfxcomMessages
{
   ...
   public:
      ...
      //--------------------------------------------------------------
      CTempHumidityBarometric(boost::shared_ptr<yApi::IYadomsApi> context, const RBUF& rbuf, boost::shared_ptr<const ISequenceNumberProvider> seqNumberProvider);
   ...
   private:
      ...
      //--------------------------------------------------------------
      yApi::commands::CPressure m_pressure;
