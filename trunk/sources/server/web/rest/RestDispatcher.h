...
namespace web { namespace rest {
   ...
   private:
      ...
      ///\return        the data in Json format
      //-------------------------------------- 
      shared::CDataContainer callRealMethod(CRestMethodHandler realMethod, CRestMethodIndirector encapsulatedMethod, const std::vector<std::string> & url, const std::string & requestContent);
