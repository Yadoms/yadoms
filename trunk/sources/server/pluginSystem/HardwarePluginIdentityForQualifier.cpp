...
CPluginIdentity::CPluginIdentity(const boost::shared_ptr<const IHardwarePluginInformation> pluginInformation)
   :m_name(pluginInformation->getName()), m_version(pluginInformation->getVersion()), m_releaseType(pluginInformation->getReleaseType())
{
}

CPluginIdentity::CPluginIdentity(const std::string& name, const std::string& version, IHardwarePluginInformation::EReleaseType releaseType)
...
const IHardwarePluginInformation::EReleaseType CPluginIdentity::getReleaseType() const
{
