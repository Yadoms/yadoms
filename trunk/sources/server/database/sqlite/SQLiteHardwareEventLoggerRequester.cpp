...
int CSQLiteHardwareEventLoggerRequester::addEvent(const std::string & pluginName, const std::string & pluginVersion, const shared::plugin::information::EReleaseType pluginReleaseType, const CHardwareEventLogger::EEventType eventType, const std::string & message /*= CStringExtension::EmptyString*/)
{
...
std::vector<boost::shared_ptr<CHardwareEventLogger> > CSQLiteHardwareEventLoggerRequester::getHardwareEvents(const std::string & pluginName, const std::string & pluginVersion, const shared::plugin::information::EReleaseType pluginReleaseType)
{
   CQuery qSelect;
   qSelect. Select().
      From(CHardwareEventLoggerTable::getTableName()).
...
std::vector<boost::shared_ptr<CHardwareEventLogger> > CSQLiteHardwareEventLoggerRequester::getHardwareEvents(const std::string & pluginName, const std::string & pluginVersion, const shared::plugin::information::EReleaseType pluginReleaseType, const boost::posix_time::ptime & fromDate)
{
   CQuery qSelect;
   qSelect. Select().
      From(CHardwareEventLoggerTable::getTableName()).
