   ...
   namespace sqlite {
      namespace adapters {
         ...
         DECLARE_ADAPTER_IMPLEMENTATION(Keyword,
            ...
            ((AccessMode)(database::entities::EKeywordAccessMode)(database::entities::EKeywordAccessMode::kNoAccess)(std::string))
            ((Name)(std::string)(""))
            ((FriendlyName)(std::string)(""))
            ((Type)(database::entities::EKeywordDataType)(database::entities::EKeywordDataType::kString)(std::string))
            ((Units)(std::string)(""))
            ((Details)(shared::CDataContainer)(shared::CDataContainer()))
         )
