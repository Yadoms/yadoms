...
namespace database { namespace sqlite { 
   ...
   namespace requesters { 
      ...
      public:
         ...
         virtual boost::shared_ptr< database::entities::CAcquisition > saveData(const int keywordId, const std::string & data, boost::posix_time::ptime & dataTime);
         virtual boost::shared_ptr< database::entities::CAcquisition > incrementData(const int keywordId, const std::string & increment, boost::posix_time::ptime & dataTime);
         virtual database::IAcquisitionRequester::LastSummaryData saveSummaryData(const int keywordId, boost::posix_time::ptime & dataTime);
