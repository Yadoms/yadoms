...
namespace database {
   namespace entities {
      ...
      Configuration,
         ...
         ((SecurityAccess)(database::entities::ESecurityAccess)(database::entities::kNone)("securityAccess"))
      ...
      ((Id)(int)(0)("id"))
         ...
         ((EventType)(database::entities::EEventType)(database::entities::kUnload)("eventType"))
      ...
      EventLogger,
         ...
         ((Code)(database::entities::ESystemEventCode)(database::entities::kDefaultCode)("code"))
         ((Who)(std::string)("")("who"))
      ...
      Keyword,
         ...
         ((AccessMode)(database::entities::EKeywordAccessMode)(database::entities::kNoAccess)("accessMode"))
         ((Name)(std::string)("")("name"))
         ((FriendlyName)(std::string)("")("friendlyName"))
         ((Type)(database::entities::EKeywordDataType)(database::entities::kString)("type"))
