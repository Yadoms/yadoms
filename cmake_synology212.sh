...
case "$choice" in
	...
	$cmake_executable  -DCMAKE_YADOMS_PLATFORM=Synology212 -DCC_RPI_GCC=arm-marvell-linux-gnueabi-gcc -DCC_RPI_GXX=arm-marvell-linux-gnueabi-g++  -DCMAKE_TOOLCHAIN_FILE=../sources/cmake/synology212.cmake ../sources
	;;

    r)
	# cmake for cross compilation RELEASE
	cmake -DCMAKE_BUILD_TYPE="Release" -DCMAKE_YADOMS_PLATFORM=Synology212 -DCC_RPI_GCC=arm-marvell-linux-gnueabi-gcc -DCC_RPI_GXX=arm-marvell-linux-gnueabi-g++  -DCMAKE_TOOLCHAIN_FILE=../sources/cmake/synology212.cmake ../sources
	;;
