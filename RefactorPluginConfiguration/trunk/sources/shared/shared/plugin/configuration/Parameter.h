...
namespace shared { namespace plugin { namespace configuration
{
   ...
   //--------------------------------------------------------------
   /// \class Plugin configuration parameter base class
   //--------------------------------------------------------------
   class YADOMS_SHARED_EXPORT CParameter
   {
   public:
      //--------------------------------------------------------------
      /// \brief	    Constructor
      ...
      //--------------------------------------------------------------
      CParameter(const std::string& type, const std::string& name, const std::string& description);
      ...
      /// \brief	    Clone method
      //--------------------------------------------------------------
      virtual boost::shared_ptr<CParameter> clone() const = 0;
