...
case "$choice" in
	...
	cmake -D CMAKE_C_COMPILER=$YADOMS_CCMACOS_TRIPLET-clang -D CMAKE_CXX_COMPILER=$YADOMS_CCMACOS_TRIPLET-clang++ -DCMAKE_TOOLCHAIN_FILE=../sources/ccmacos.cmake ../sources
	;;	
	...
	export OSXCROSS_HOST="$YADOMS_CCMACOS_TRIPLET"
	# cmake for makefile (cross compilation)
	cmake -DCMAKE_BUILD_TYPE="Release" -D CMAKE_C_COMPILER=$YADOMS_CCMACOS_TRIPLET-clang -D CMAKE_CXX_COMPILER=$YADOMS_CCMACOS_TRIPLET-clang++ -DCMAKE_TOOLCHAIN_FILE=../cmake/ccmacos.cmake ../sources
	;;	
