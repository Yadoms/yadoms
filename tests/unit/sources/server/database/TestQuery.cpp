...
bool BothAreSpaces(const char lhs, const char rhs) { return (lhs == rhs) && (lhs == ' '); }


std::string BeautifyQuery(database::common::CQuery & q)
{
   //trim spaces
   auto trim = boost::trim_copy(q.str());
   
   //replace any double space by only one
   const auto newEnd = std::unique(trim.begin(), trim.end(), BothAreSpaces);
   trim.erase(newEnd, trim.end());
...
BOOST_AUTO_TEST_CASE(InsertInto)
{
   ...
   test1.InsertInto(database::common::CKeywordTable::getTableName(), database::common::CKeywordTable::getDeviceIdColumnName(), database::common::CKeywordTable::getCapacityNameColumnName(), database::common::CKeywordTable::getAccessModeColumnName(), database::common::CKeywordTable::getNameColumnName(), database::common::CKeywordTable::getTypeColumnName(), database::common::CKeywordTable::getMeasureColumnName()).
      Values(1, "temperature", shared::plugin::yPluginApi::EKeywordAccessMode::kGet, "test", shared::plugin::yPluginApi::EKeywordDataType::kNumeric, shared::plugin::yPluginApi::EMeasureType::kAbsolute);
...
BOOST_AUTO_TEST_CASE(InsertOrReplaceSqlite)
{
   ...
   const std::string curType = "Month";
   const std::string toQuery = "Day";
   const auto fromDate = boost::posix_time::from_iso_string("20190101T000000");
   const auto toDate = boost::posix_time::from_iso_string("20190131T000000");
   constexpr auto keywordId = 42;
   ...
   q.InsertOrReplaceInto(database::common::CAcquisitionSummaryTable::getTableName(), database::common::CAcquisitionSummaryTable::getTypeColumnName(),
      ...
      Select(curType, fromDate, keywordId, q.average(q.fromSubquery("acq", database::common::CAcquisitionSummaryTable::getAvgColumnName())),
      ...
      Where(q.fromSubquery("acq", database::common::CAcquisitionSummaryTable::getKeywordIdColumnName()), database::common::CQUERY_OP_EQUAL, keywordId).
      And(q.fromSubquery("acq", database::common::CAcquisitionSummaryTable::getTypeColumnName()), database::common::CQUERY_OP_EQUAL, toQuery).
      And(q.fromSubquery("acq", database::common::CAcquisitionSummaryTable::getDateColumnName()), database::common::CQUERY_OP_SUP_EQUAL, fromDate).
      And(q.fromSubquery("acq", database::common::CAcquisitionSummaryTable::getDateColumnName()), database::common::CQUERY_OP_INF_EQUAL, toDate);
...
BOOST_AUTO_TEST_CASE(Update)
{
   ...
   test1.Update(database::common::CKeywordTable::getTableName()).Set(database::common::CKeywordTable::getFriendlyNameColumnName(), "garage").
      Where(database::common::CKeywordTable::getDeviceIdColumnName(), database::common::CQUERY_OP_EQUAL, 42).
      And(database::common::CKeywordTable::getNameColumnName(), database::common::CQUERY_OP_EQUAL, "2.42635");

   const auto checkQuery = (boost::format(
...
BOOST_AUTO_TEST_CASE(UpdateOperation)
{
   ...
   q.Update(database::common::CAcquisitionSummaryTable::getTableName()).
      ...
      Where(database::common::CAcquisitionSummaryTable::getKeywordIdColumnName(), database::common::CQUERY_OP_EQUAL, 42);
   ...
   q2.Update(database::common::CAcquisitionSummaryTable::getTableName()).
      Set(database::common::CAcquisitionSummaryTable::getAvgColumnName(), q2.math(database::common::CAcquisitionSummaryTable::getAvgColumnName(), database::common::CQUERY_OP_MUL, 3600),
         database::common::CAcquisitionSummaryTable::getMinColumnName(), q2.math(database::common::CAcquisitionSummaryTable::getMinColumnName(), database::common::CQUERY_OP_MUL, 3600),
         database::common::CAcquisitionSummaryTable::getMaxColumnName(), q2.math(database::common::CAcquisitionSummaryTable::getMaxColumnName(), database::common::CQUERY_OP_MUL, 3600)).
      Where(database::common::CAcquisitionSummaryTable::getKeywordIdColumnName(), database::common::CQUERY_OP_EQUAL, 42);
   BOOST_CHECK_EQUAL(BeautifyQuery(q2), checkQuery);
...
BOOST_AUTO_TEST_CASE(WhereIn)
{
   ...
   intVectorPgsqlQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, intVector);
   ...
   intVectorSQLiteQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, intVector);
   ...
   strVectorPgsqlQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, strVector);
   ...
   strVectorSQLiteQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, strVector);
   ...
   intSetPgsqlQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, intSet);
   ...
   intSetSQLiteQuery.Select("column1").From("table").Where("column2", database::common::CQUERY_OP_IN, intSet);
