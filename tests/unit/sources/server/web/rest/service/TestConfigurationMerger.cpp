...
#include "../../../../sources/server/web/rest/service/ConfigurationMerger.h"


BOOST_AUTO_TEST_SUITE(TestConfigurationMerger)
    ...
    "SystemData": {
      ...
      "content": {
		...
		BOOST_CHECK_EQUAL(web::rest::service::CConfigurationMerger::mergeConfigurationAndSchema(schema, configuration)->serialize(),
		                  merged.serialize());

		BOOST_CHECK_EQUAL(web::rest::service::CConfigurationMerger::extractConfiguration(merged)->serialize(),
    ...
    "SystemData": {
      ...
      "content": {
		...
		BOOST_CHECK_EQUAL(web::rest::service::CConfigurationMerger::mergeConfigurationAndSchema(schema, shared::CDataContainer())->serialize(),
		                  merged.serialize());
		BOOST_CHECK_EQUAL(web::rest::service::CConfigurationMerger::mergeConfigurationAndSchema(schema, shared::CDataContainer(R"({})"))->serialize(),
		                  merged.serialize());
	}
