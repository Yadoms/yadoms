...
BOOST_AUTO_TEST_SUITE(TestDiscoveredDevice)
   ...
   {
      static const auto ssdpLocation = std::string("http://192.168.1.1:1990/4ab37c24-b4fc-42c3-bdba-97a6ebeea57c/WFADevice.xml");
      ...
      const shared::http::ssdp::CDiscoveredDevice dd(ssdpLocation, ssdpAnswer);
   ...
   {
      static const auto ssdpLocation = std::string("TODO");
      static const auto ssdpAnswer = std::string(
      ...
      const shared::http::ssdp::CDiscoveredDevice dd(ssdpLocation, ssdpAnswer);
      BOOST_CHECK_EQUAL(dd.ip(), "192.168.0.2");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("deviceType"),
                        "urn:schemas-upnp-org:device:Basic:1");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("friendlyName"), "NAS (DS216+II)");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturer"), "Synology");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturerURL"), "http://www.synology.com");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelDescription"), "Synology NAS");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelName"), "DS216+II");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelNumber"), "DS216+II 6.2-25426");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelURL"), "http://www.synology.com");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelType"), "NAS");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("serialNumber"), "0011325e4496");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("UDN"), "uuid:73796E6F-6473-6D00-0000-0011325e4496");
   }
   ...
   BOOST_AUTO_TEST_CASE(SynologyDS216IIPlusDesc)
   {
      ...
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("friendlyName"), "NAS");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturer"), "Synology Inc.");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturerURL"), "http://www.synology.com");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelDescription"),
                        "Synology DLNA/UPnP Media Server");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelName"), "DS216+II");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelURL"), "http://www.synology.com");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("serialNumber"), "1650O6N558101");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("UDN"), "uuid:0011325e-4496-0011-9644-96445e32110");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("presentationURL"), "http://192.168.0.2:5000/");
   }
   ...
   BOOST_AUTO_TEST_CASE(NetgearDG834GV4)
   {
      ...
      const shared::http::ssdp::CDiscoveredDevice dd(ssdpLocation, ssdpAnswer);
      BOOST_CHECK_EQUAL(dd.ip(), "192.168.0.1");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("deviceType"),
                        "urn:schemas-upnp-org:device:InternetGatewayDevice:1");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("friendlyName"), "NETGEAR DG834GV4 Router");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturer"), "NETGEAR ");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturerURL"), "http://www.netgear.com/");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelDescription"),                        "NETGEAR DG834GV4 Router");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelName"), "NETGEAR DG834GV4 Router");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelNumber"), "5.01.16");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelURL"), "http://www.netgear.com/");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("serialNumber"), " ");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("UDN"), "uuid:824ff22b-8c7d-41c5-a131-44f534e12555");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("presentationURL"), "http://192.168.0.1/");
   }
   ...
   BOOST_AUTO_TEST_CASE(TpLinkTLWA801N)
   {
      ...
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("friendlyName"), "WPS Access Point");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturer"), "TP-LINK");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("manufacturerURL"), "http://www.tp-link.com");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelDescription"),                        "Wireless N Router");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelName"), "TL-WA801N");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelNumber"), "2.0");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("modelURL"), "http://192.168.0.3:80");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("serialNumber"), "1.0");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("UDN"), "uuid:00000000-0000-1000-0000-e894f6a317f3");
      BOOST_CHECK_EQUAL(dd.deviceDescription()->get<std::string>("UPC"), "UPC here");
   }
