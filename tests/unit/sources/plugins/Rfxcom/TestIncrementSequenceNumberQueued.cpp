...
#include "../../../../sources/plugins/Rfxcom/IncrementSequenceNumberQueued.h"

BOOST_AUTO_TEST_SUITE(TestIncrementSequenceNumberQueued)

   BOOST_AUTO_TEST_CASE(Nominal)
   {
      CIncrementSequenceNumberQueued seqNumber;
   ...
   BOOST_AUTO_TEST_CASE(Resynchronize)
   {
      ...
      BOOST_CHECK(seqNumber.isExpected(60));
