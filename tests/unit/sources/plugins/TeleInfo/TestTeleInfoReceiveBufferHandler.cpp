...
{
public:
    BufferLoggerMock() = default;
    ~BufferLoggerMock() override = default;
    BufferLoggerMock(const BufferLoggerMock&) = delete;
    BufferLoggerMock(BufferLoggerMock&&) = delete;
    BufferLoggerMock& operator=(const BufferLoggerMock&) = delete;
    BufferLoggerMock& operator=(BufferLoggerMock&&) = delete;
    ...
    static std::string msgToString(const shared::communication::CByteBuffer& data)
    {
        return "";
    }
};
...
public:
    CTeleInfoReceiveBufferHandlerMock(shared::event::CEventHandler& receiveDataEventHandler,
                                      ...
                                      const boost::shared_ptr<shared::communication::IBufferLogger>& logger)
    ...
    static boost::shared_ptr<std::map<std::string, std::string>> getMessages(const boost::shared_ptr<const std::vector<unsigned char>>& frame)
    {
...
BOOST_AUTO_TEST_SUITE(TestTeleInfoReceiveBufferHandler)
    ...
    BOOST_AUTO_TEST_CASE(GetMessages)
    {
        ...
        const auto out = CTeleInfoReceiveBufferHandlerMock::getMessages(frame);
        BOOST_CHECK_EQUAL(*out == expectedMap, true);
    }

    BOOST_AUTO_TEST_CASE(Nominal)
    {
        const auto frame = serialTeleInfoMessage::normalizeFrame(
    ...
    {
        const auto frame1 = serialTeleInfoMessage::normalizeFrame(
            "<stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BASE 006238747 0<cr><lf>PTEC TH.. $<cr><lf>IINST 008 _<cr><lf>IMAX 025 F<cr><lf>PAPP 01940 /<cr><lf>MOTDETAT 000000 B<cr><etx><stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BASE 006238747 0<cr><lf>PTEC TH.. $<cr><lf>IINST 008 _<cr><lf>IMAX 025 F<cr><lf>PAPP 01940 /<cr><lf>MOTDETAT 000000 B<cr><etx>");
        const std::map<std::string, std::string> expectedMap = {
            {"ADCO", "031428097115"},
            {"OPTARIF", "BASE"},
    ...
    BOOST_AUTO_TEST_CASE(LfChangeToStx)
    {
        const auto frame = serialTeleInfoMessage::normalizeFrame(
    ...
    BOOST_AUTO_TEST_CASE(LfChangeToStx2)
    {
        const auto frame = serialTeleInfoMessage::normalizeFrame(
    ...
    BOOST_AUTO_TEST_CASE(LastDefault)
    {
        //<stx>F<cr><lf>PAPP 00280 +<cr><lf>MOTDETAT 000000 B<cr><etx><stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BASE 008453671 -<cr><lf>PTEC TH.. $<cr><lf>IINST 001 X<cr><lf>IMAX 025 F<cr><lf>PAPP 00280 +<cr><lf>MOTDETAT 000000 B<cr><etx><stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BASE 008453671 -<cr><lf>PTEC TH.. $<cr><lf>IINST 001 X<cr><lf>IMAX 025 F<cr><lf>PAPP 00270 *<cr><lf>MOTDETAT 000000 B<cr><etx><stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BASE 008453671 -<cr><lf>PTEC TH.. $<cr><lf>IINST 001 X<cr><lf>IMAX 025 F<cr><lf>PAPP 00270 *<cr><lf>MOTDETAT 000000 B<cr><etx><stx><lf>ADCO 031428097115 @
        const auto frame = serialTeleInfoMessage::normalizeFrame(
        ...
        bufferHandler.push(shared::communication::CByteBuffer(
            serialTeleInfoMessage::normalizeFrame("<etx><stx><lf>ADCO 031428097115 @<cr><lf>OPTARIF BASE 0<cr><lf>ISOUSC 30 9<cr><lf>BAS")));
